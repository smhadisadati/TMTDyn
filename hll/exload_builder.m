classdef exload_builder < handle
    ...
    methods
        ...
        function transformation = with_transformation_on_body( self, exbody_val , mesh_no, axial_loc )
			if nargin > 1
                if nargin < 3
                    mesh_no = 1;
                end
        ...
        function transformation = with_transformation_on_body_tip( self, exbody_val , mesh_no )
			if nargin > 1
                if nargin < 3
                    mesh_no = 1;
                end
