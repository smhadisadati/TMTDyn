 ...
 * sprdmpF29.c
 *
 * Code generation for function 'sprdmpF29'
 *
 */
...
static emlrtRSInfo xh_emlrtRSI = { 144,/* lineNo */
  "sprdmpF29",                         /* fcnName */
  "C:\\Users\\customer\\MEGAsync\\Hadi\\Postdoc\\2_KCL\\2_Research\\2. Model\\CTR TMTDyn\\eom\\sprdmpF29.m"/* pathName */
};

static emlrtRSInfo bi_emlrtRSI = { 182,/* lineNo */
  "sprdmpF29",                         /* fcnName */
  "C:\\Users\\customer\\MEGAsync\\Hadi\\Postdoc\\2_KCL\\2_Research\\2. Model\\CTR TMTDyn\\eom\\sprdmpF29.m"/* pathName */
};

/* Function Definitions */
void sprdmpF29(const emlrtStack *sp, const real_T in1[60], const real_T in2[48],
               ...
               real_T out4[6], real_T *out6)
{
  ...
  out1[7] = t1924;
  out1[8] = t818;
  memset(&out1[9], 0, 10U * sizeof(real_T));
  ...
  out1[32] = ((((((-t683 + -t456) + t599) + -t1641) + -t963) + t1673) + t427) +
    -t987 * t683_tmp_tmp;
  memset(&out1[33], 0, 10U * sizeof(real_T));
  out1[43] = t1907;
  ...
  out1[55] = t1923;
  out1[56] = t822;
  memset(&out1[57], 0, 10U * sizeof(real_T));
  ...
  out1[80] = t87;
  memset(&out1[81], 0, 10U * sizeof(real_T));
  ...
  out1[103] = t1934;
  out1[104] = t454;
  memset(&out1[105], 0, 10U * sizeof(real_T));
  ...
  out1[128] = t7;
  memset(&out1[129], 0, 10U * sizeof(real_T));
  out1[139] = t1914;
...
/* End of code generation (sprdmpF29.c) */
