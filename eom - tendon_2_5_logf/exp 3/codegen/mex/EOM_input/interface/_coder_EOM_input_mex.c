...
void mexFunction(int32_T nlhs, mxArray *plhs[], int32_T nrhs, const mxArray
                 *prhs[])
{
  EOM_inputStackData *EOM_inputStackDataGlobal = NULL;
  (void)prhs;
  EOM_inputStackDataGlobal = (EOM_inputStackData *)emlrtMxCalloc(1, (size_t)1U *
    sizeof(EOM_inputStackData));
  ...
  EOM_input_mexFunction(EOM_inputStackDataGlobal, nlhs, plhs, nrhs);

  /* Module termination. */
  EOM_input_terminate();
  emlrtMxFree(EOM_inputStackDataGlobal);
}
