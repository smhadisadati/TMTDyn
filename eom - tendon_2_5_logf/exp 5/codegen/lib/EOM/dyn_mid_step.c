...
void dyn_mid_step(double t, struct0_T *par_mex)
{
  ...
  if ((t <= varargin_1[14586]) && (t >= varargin_1[0])) {
    ...
    if (xtmp == 0.0) {
      ...
      l_w_idx_1 = b_varargin_2[low_i + 14586];
      l_w_idx_2 = b_varargin_2[low_i + 29173];
      xtmp = b_varargin_2[low_i + 43760];
    } else if (xtmp == 1.0) {
      l_w_idx_0 = b_varargin_2[low_i];
      l_w_idx_1 = b_varargin_2[low_i + 14587];
      l_w_idx_2 = b_varargin_2[low_i + 29174];
