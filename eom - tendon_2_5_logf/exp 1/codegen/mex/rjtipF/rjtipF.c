            ...
            real_T s, real_T ds, real_T t_sym, real_T out1[15])
{
  ...
  t8 = (((in2[8] * t26 + in2[9] * t9 * t23 * 3.0) + -((in2[9] + -in2[11]) * t52 *
          t61)) + t3 * t64) + 1.0;
  t26 = muDoubleScalarCos(t77);
  t52 = muDoubleScalarSin(t77);
  st.site = &i_emlrtRSI;
  ...
  out1[5] = rtNaN;
  out1[6] = t26 * t3;
  out1[7] = t26 * t81 * t61 * t8 * -0.5 + t52 * t80 * t61 * t8 / 2.0;
  out1[8] = t26 * t80 * t61 * t8 / 2.0 + t52 * t81 * t61 * t8 / 2.0;
  out1[9] = t52 * t3;
  out1[10] = rtNaN;
  out1[11] = rtNaN;
  out1[12] = rtNaN;
