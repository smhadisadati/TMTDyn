...
## 
## Makefile     : EOM_rtw.mk
## Generated on : Tue Apr 06 13:11:39 2021
...
OBJS = EOM_data.obj EOM_initialize.obj EOM_terminate.obj EOM.obj massT1.obj sprdmpTt18.obj sprdmpKx18.obj sprdmpVd18.obj loadsTt1.obj pinv.obj svd.obj xnrm2.obj xdotc.obj EOM_input.obj dyn_mid_step.obj xaxpy.obj xrotg.obj xrot.obj xswap.obj
...
sprdmpTt18.obj : $(START_DIR)\sprdmpTt18.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sprdmpTt18.c


sprdmpKx18.obj : $(START_DIR)\sprdmpKx18.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sprdmpKx18.c


sprdmpVd18.obj : $(START_DIR)\sprdmpVd18.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sprdmpVd18.c
