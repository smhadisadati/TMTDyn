        ...
        try
            ...
            switch par.dyn 
                case { 1, 2, 4, 5 } % 1-'generate_m_file', 2-'generate_mex_file', 4-'generate_mex_from_edited_m_file', 5-'edited_m_file'       
                    ...
                    error('no ./eom/user_codes/results.txt file is found! see above instructions.')
                    % t = []; z = []; tfinal = [];
                    % return
            ...
            fprintf( 'importing external results from file results.txt ... \n' ) % import results
            results_file = './eom/user_codes/results.txt'; % default generated code location where Demo_mex generate results
            delimiterIn = '\t';
            results = importdata( results_file, delimiterIn );
        end        
        t = results(:,1);
