...
MAKEFILE = sprdmpF74_mex.mk

include sprdmpF74_mex.mki
...
SRC_FILES =  \
	...
	sprdmpF74.c \
	_coder_sprdmpF74_info.c \
	_coder_sprdmpF74_api.c \
	_coder_sprdmpF74_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF74_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF74"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF74/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF74/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF74/%.cu
	$(CC) $(CCFLAGS) "$<"
