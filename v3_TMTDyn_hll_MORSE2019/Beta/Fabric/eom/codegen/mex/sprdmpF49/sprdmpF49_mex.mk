...
MAKEFILE = sprdmpF49_mex.mk

include sprdmpF49_mex.mki


SRC_FILES =  \
	sprdmpF49_data.c \
	sprdmpF49_initialize.c \
	sprdmpF49_terminate.c \
	sprdmpF49.c \
	_coder_sprdmpF49_info.c \
	_coder_sprdmpF49_api.c \
	_coder_sprdmpF49_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF49_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF49"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF49/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF49/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF49/%.cu
	$(CC) $(CCFLAGS) "$<"
