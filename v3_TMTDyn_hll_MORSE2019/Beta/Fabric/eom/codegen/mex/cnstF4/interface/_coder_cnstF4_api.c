 ...
 * _coder_cnstF4_api.c
 *
 * Code generation for function '_coder_cnstF4_api'
 *
 */
...
void cnstF4_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray *
                plhs[3])
{
  real_T (*out1)[106];
  real_T (*out2)[106];
  ...
  cnstF4(*in1, *in2, s, *out1, *out2, &out3);
...
/* End of code generation (_coder_cnstF4_api.c) */
