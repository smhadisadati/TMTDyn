...
MAKEFILE = sprdmpF101_mex.mk

include sprdmpF101_mex.mki


SRC_FILES =  \
	sprdmpF101_data.c \
	sprdmpF101_initialize.c \
	sprdmpF101_terminate.c \
	sprdmpF101.c \
	_coder_sprdmpF101_info.c \
	_coder_sprdmpF101_api.c \
	_coder_sprdmpF101_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF101_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF101"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF101/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF101/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF101/%.cu
	$(CC) $(CCFLAGS) "$<"
