...
MAKEFILE = sprdmpF31_mex.mk

include sprdmpF31_mex.mki


SRC_FILES =  \
	sprdmpF31_data.c \
	sprdmpF31_initialize.c \
	sprdmpF31_terminate.c \
	sprdmpF31.c \
	_coder_sprdmpF31_info.c \
	_coder_sprdmpF31_api.c \
	_coder_sprdmpF31_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF31_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF31"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF31/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF31/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF31/%.cu
	$(CC) $(CCFLAGS) "$<"
