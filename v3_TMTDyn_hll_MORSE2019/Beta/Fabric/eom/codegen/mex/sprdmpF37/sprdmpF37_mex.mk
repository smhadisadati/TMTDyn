...
MAKEFILE = sprdmpF37_mex.mk

include sprdmpF37_mex.mki


SRC_FILES =  \
	sprdmpF37_data.c \
	sprdmpF37_initialize.c \
	sprdmpF37_terminate.c \
	sprdmpF37.c \
	_coder_sprdmpF37_info.c \
	_coder_sprdmpF37_api.c \
	_coder_sprdmpF37_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF37_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF37"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF37/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF37/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF37/%.cu
	$(CC) $(CCFLAGS) "$<"
