...
MAKEFILE = sprdmpF10_mex.mk

include sprdmpF10_mex.mki


SRC_FILES =  \
	sprdmpF10_data.c \
	sprdmpF10_initialize.c \
	sprdmpF10_terminate.c \
	sprdmpF10.c \
	_coder_sprdmpF10_info.c \
	_coder_sprdmpF10_api.c \
	_coder_sprdmpF10_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF10_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF10"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF10/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF10/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF10/%.cu
	$(CC) $(CCFLAGS) "$<"
