...
MAKEFILE = cnstF5_mex.mk

include cnstF5_mex.mki
...
SRC_FILES =  \
	...
	cnstF5_terminate.c \
	cnstF5.c \
	_coder_cnstF5_info.c \
	_coder_cnstF5_api.c \
	_coder_cnstF5_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = cnstF5_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/cnstF5"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/cnstF5/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/cnstF5/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/cnstF5/%.cu
	$(CC) $(CCFLAGS) "$<"
