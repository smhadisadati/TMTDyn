...
MAKEFILE = sprdmpF120_mex.mk

include sprdmpF120_mex.mki


SRC_FILES =  \
	sprdmpF120_data.c \
	sprdmpF120_initialize.c \
	sprdmpF120_terminate.c \
	sprdmpF120.c \
	error.c \
	sqrt.c \
	_coder_sprdmpF120_info.c \
	_coder_sprdmpF120_api.c \
	_coder_sprdmpF120_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF120_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF120"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF120/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF120/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF120/%.cu
	$(CC) $(CCFLAGS) "$<"
