...
MAKEFILE = sprdmpF108_mex.mk

include sprdmpF108_mex.mki


SRC_FILES =  \
	sprdmpF108_data.c \
	sprdmpF108_initialize.c \
	sprdmpF108_terminate.c \
	sprdmpF108.c \
	error.c \
	sqrt.c \
	_coder_sprdmpF108_info.c \
	_coder_sprdmpF108_api.c \
	_coder_sprdmpF108_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF108_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF108"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF108/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF108/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF108/%.cu
	$(CC) $(CCFLAGS) "$<"
