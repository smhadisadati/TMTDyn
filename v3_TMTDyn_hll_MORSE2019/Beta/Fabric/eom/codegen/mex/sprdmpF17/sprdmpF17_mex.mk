...
MAKEFILE = sprdmpF17_mex.mk

include sprdmpF17_mex.mki


SRC_FILES =  \
	sprdmpF17_data.c \
	sprdmpF17_initialize.c \
	sprdmpF17_terminate.c \
	sprdmpF17.c \
	_coder_sprdmpF17_info.c \
	_coder_sprdmpF17_api.c \
	_coder_sprdmpF17_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF17_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF17"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF17/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF17/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF17/%.cu
	$(CC) $(CCFLAGS) "$<"
