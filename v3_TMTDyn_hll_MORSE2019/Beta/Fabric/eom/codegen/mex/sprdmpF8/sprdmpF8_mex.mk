...
MAKEFILE = sprdmpF8_mex.mk

include sprdmpF8_mex.mki


SRC_FILES =  \
	sprdmpF8_data.c \
	sprdmpF8_initialize.c \
	sprdmpF8_terminate.c \
	sprdmpF8.c \
	_coder_sprdmpF8_info.c \
	_coder_sprdmpF8_api.c \
	_coder_sprdmpF8_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF8_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF8"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF8/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF8/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF8/%.cu
	$(CC) $(CCFLAGS) "$<"
