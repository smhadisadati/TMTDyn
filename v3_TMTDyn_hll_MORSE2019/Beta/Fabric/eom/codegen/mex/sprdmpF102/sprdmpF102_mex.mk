...
MAKEFILE = sprdmpF102_mex.mk

include sprdmpF102_mex.mki


SRC_FILES =  \
	sprdmpF102_data.c \
	sprdmpF102_initialize.c \
	sprdmpF102_terminate.c \
	sprdmpF102.c \
	_coder_sprdmpF102_info.c \
	_coder_sprdmpF102_api.c \
	_coder_sprdmpF102_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF102_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF102"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF102/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF102/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF102/%.cu
	$(CC) $(CCFLAGS) "$<"
