...
MAKEFILE = sprdmpF58_mex.mk

include sprdmpF58_mex.mki


SRC_FILES =  \
	sprdmpF58_data.c \
	sprdmpF58_initialize.c \
	sprdmpF58_terminate.c \
	sprdmpF58.c \
	_coder_sprdmpF58_info.c \
	_coder_sprdmpF58_api.c \
	_coder_sprdmpF58_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF58_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF58"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF58/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF58/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF58/%.cu
	$(CC) $(CCFLAGS) "$<"
