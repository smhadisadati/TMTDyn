...
MAKEFILE = sprdmpF94_mex.mk

include sprdmpF94_mex.mki


SRC_FILES =  \
	sprdmpF94_data.c \
	sprdmpF94_initialize.c \
	sprdmpF94_terminate.c \
	sprdmpF94.c \
	_coder_sprdmpF94_info.c \
	_coder_sprdmpF94_api.c \
	_coder_sprdmpF94_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF94_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF94"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF94/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF94/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF94/%.cu
	$(CC) $(CCFLAGS) "$<"
