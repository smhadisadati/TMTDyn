...
MAKEFILE = sprdmpF112_mex.mk

include sprdmpF112_mex.mki


SRC_FILES =  \
	sprdmpF112_data.c \
	sprdmpF112_initialize.c \
	sprdmpF112_terminate.c \
	sprdmpF112.c \
	error.c \
	sqrt.c \
	_coder_sprdmpF112_info.c \
	_coder_sprdmpF112_api.c \
	_coder_sprdmpF112_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF112_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF112"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF112/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF112/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF112/%.cu
	$(CC) $(CCFLAGS) "$<"
