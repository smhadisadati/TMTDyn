...
MAKEFILE = sprdmpF14_mex.mk

include sprdmpF14_mex.mki


SRC_FILES =  \
	sprdmpF14_data.c \
	sprdmpF14_initialize.c \
	sprdmpF14_terminate.c \
	sprdmpF14.c \
	_coder_sprdmpF14_info.c \
	_coder_sprdmpF14_api.c \
	_coder_sprdmpF14_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF14_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF14"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF14/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF14/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF14/%.cu
	$(CC) $(CCFLAGS) "$<"
