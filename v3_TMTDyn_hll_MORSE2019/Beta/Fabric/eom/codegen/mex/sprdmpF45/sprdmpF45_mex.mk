...
MAKEFILE = sprdmpF45_mex.mk

include sprdmpF45_mex.mki


SRC_FILES =  \
	sprdmpF45_data.c \
	sprdmpF45_initialize.c \
	sprdmpF45_terminate.c \
	sprdmpF45.c \
	_coder_sprdmpF45_info.c \
	_coder_sprdmpF45_api.c \
	_coder_sprdmpF45_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF45_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF45"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF45/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF45/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF45/%.cu
	$(CC) $(CCFLAGS) "$<"
