...
MAKEFILE = sprdmpF119_mex.mk

include sprdmpF119_mex.mki


SRC_FILES =  \
	sprdmpF119_data.c \
	sprdmpF119_initialize.c \
	sprdmpF119_terminate.c \
	sprdmpF119.c \
	error.c \
	sqrt.c \
	_coder_sprdmpF119_info.c \
	_coder_sprdmpF119_api.c \
	_coder_sprdmpF119_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF119_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF119"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF119/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF119/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF119/%.cu
	$(CC) $(CCFLAGS) "$<"
