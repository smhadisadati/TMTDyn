...
MAKEFILE = sprdmpF100_mex.mk

include sprdmpF100_mex.mki


SRC_FILES =  \
	sprdmpF100_data.c \
	sprdmpF100_initialize.c \
	sprdmpF100_terminate.c \
	sprdmpF100.c \
	_coder_sprdmpF100_info.c \
	_coder_sprdmpF100_api.c \
	_coder_sprdmpF100_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF100_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF100"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF100/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF100/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF100/%.cu
	$(CC) $(CCFLAGS) "$<"
