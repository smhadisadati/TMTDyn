...
MAKEFILE = sprdmpF32_mex.mk

include sprdmpF32_mex.mki


SRC_FILES =  \
	sprdmpF32_data.c \
	sprdmpF32_initialize.c \
	sprdmpF32_terminate.c \
	sprdmpF32.c \
	_coder_sprdmpF32_info.c \
	_coder_sprdmpF32_api.c \
	_coder_sprdmpF32_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF32_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF32"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF32/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF32/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF32/%.cu
	$(CC) $(CCFLAGS) "$<"
