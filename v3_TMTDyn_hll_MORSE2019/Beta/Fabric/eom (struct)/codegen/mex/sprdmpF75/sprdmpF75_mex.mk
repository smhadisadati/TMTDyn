...
MAKEFILE = sprdmpF75_mex.mk

include sprdmpF75_mex.mki


SRC_FILES =  \
	sprdmpF75_data.c \
	sprdmpF75_initialize.c \
	sprdmpF75_terminate.c \
	sprdmpF75.c \
	_coder_sprdmpF75_info.c \
	_coder_sprdmpF75_api.c \
	_coder_sprdmpF75_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF75_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF75"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF75/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF75/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF75/%.cu
	$(CC) $(CCFLAGS) "$<"
