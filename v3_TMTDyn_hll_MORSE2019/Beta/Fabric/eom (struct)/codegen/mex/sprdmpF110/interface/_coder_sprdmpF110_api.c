 ...
 *
 * Code generation for function '_coder_sprdmpF110_api'
 *
 */
...
void sprdmpF110_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray
                    *plhs[8])
{
  real_T (*out1)[636];
  real_T (*out2)[6];
  ...
  sprdmpF110(&st, *in1, *in2, s, *out1, *out2, *out3, *out4, &out5, *out6, *out7,
             &out8);
...
/* End of code generation (_coder_sprdmpF110_api.c) */
