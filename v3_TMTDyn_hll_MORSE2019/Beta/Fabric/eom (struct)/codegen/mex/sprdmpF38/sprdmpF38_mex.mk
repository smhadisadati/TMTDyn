...
MAKEFILE = sprdmpF38_mex.mk

include sprdmpF38_mex.mki


SRC_FILES =  \
	sprdmpF38_data.c \
	sprdmpF38_initialize.c \
	sprdmpF38_terminate.c \
	sprdmpF38.c \
	_coder_sprdmpF38_info.c \
	_coder_sprdmpF38_api.c \
	_coder_sprdmpF38_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF38_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF38"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF38/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF38/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF38/%.cu
	$(CC) $(CCFLAGS) "$<"
