...
MAKEFILE = sprdmpF36_mex.mk

include sprdmpF36_mex.mki


SRC_FILES =  \
	sprdmpF36_data.c \
	sprdmpF36_initialize.c \
	sprdmpF36_terminate.c \
	sprdmpF36.c \
	_coder_sprdmpF36_info.c \
	_coder_sprdmpF36_api.c \
	_coder_sprdmpF36_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF36_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF36"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF36/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF36/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF36/%.cu
	$(CC) $(CCFLAGS) "$<"
