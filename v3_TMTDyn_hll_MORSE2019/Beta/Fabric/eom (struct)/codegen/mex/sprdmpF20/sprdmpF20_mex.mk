...
MAKEFILE = sprdmpF20_mex.mk

include sprdmpF20_mex.mki


SRC_FILES =  \
	sprdmpF20_data.c \
	sprdmpF20_initialize.c \
	sprdmpF20_terminate.c \
	sprdmpF20.c \
	_coder_sprdmpF20_info.c \
	_coder_sprdmpF20_api.c \
	_coder_sprdmpF20_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF20_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF20"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF20/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF20/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF20/%.cu
	$(CC) $(CCFLAGS) "$<"
