...
MAKEFILE = sprdmpF41_mex.mk

include sprdmpF41_mex.mki
...
SRC_FILES =  \
	...
	sprdmpF41.c \
	_coder_sprdmpF41_info.c \
	_coder_sprdmpF41_api.c \
	_coder_sprdmpF41_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF41_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF41"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF41/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF41/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF41/%.cu
	$(CC) $(CCFLAGS) "$<"
