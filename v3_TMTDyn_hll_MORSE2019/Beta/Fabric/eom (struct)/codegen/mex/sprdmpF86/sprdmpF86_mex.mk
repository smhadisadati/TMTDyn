...
MAKEFILE = sprdmpF86_mex.mk

include sprdmpF86_mex.mki


SRC_FILES =  \
	sprdmpF86_data.c \
	sprdmpF86_initialize.c \
	sprdmpF86_terminate.c \
	sprdmpF86.c \
	_coder_sprdmpF86_info.c \
	_coder_sprdmpF86_api.c \
	_coder_sprdmpF86_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF86_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF86"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF86/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF86/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF86/%.cu
	$(CC) $(CCFLAGS) "$<"
