...
MAKEFILE = sprdmpF33_mex.mk

include sprdmpF33_mex.mki


SRC_FILES =  \
	sprdmpF33_data.c \
	sprdmpF33_initialize.c \
	sprdmpF33_terminate.c \
	sprdmpF33.c \
	_coder_sprdmpF33_info.c \
	_coder_sprdmpF33_api.c \
	_coder_sprdmpF33_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF33_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF33"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF33/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF33/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF33/%.cu
	$(CC) $(CCFLAGS) "$<"
