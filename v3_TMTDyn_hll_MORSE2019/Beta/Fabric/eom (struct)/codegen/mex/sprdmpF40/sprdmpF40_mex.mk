...
MAKEFILE = sprdmpF40_mex.mk

include sprdmpF40_mex.mki


SRC_FILES =  \
	sprdmpF40_data.c \
	sprdmpF40_initialize.c \
	sprdmpF40_terminate.c \
	sprdmpF40.c \
	_coder_sprdmpF40_info.c \
	_coder_sprdmpF40_api.c \
	_coder_sprdmpF40_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF40_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF40"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF40/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF40/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF40/%.cu
	$(CC) $(CCFLAGS) "$<"
