...
MAKEFILE = sprdmpF51_mex.mk

include sprdmpF51_mex.mki


SRC_FILES =  \
	sprdmpF51_data.c \
	sprdmpF51_initialize.c \
	sprdmpF51_terminate.c \
	sprdmpF51.c \
	_coder_sprdmpF51_info.c \
	_coder_sprdmpF51_api.c \
	_coder_sprdmpF51_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF51_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF51"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF51/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF51/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF51/%.cu
	$(CC) $(CCFLAGS) "$<"
