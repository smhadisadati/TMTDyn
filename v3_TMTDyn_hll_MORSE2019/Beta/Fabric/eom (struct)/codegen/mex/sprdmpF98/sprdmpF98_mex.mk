...
MAKEFILE = sprdmpF98_mex.mk

include sprdmpF98_mex.mki


SRC_FILES =  \
	sprdmpF98_data.c \
	sprdmpF98_initialize.c \
	sprdmpF98_terminate.c \
	sprdmpF98.c \
	_coder_sprdmpF98_info.c \
	_coder_sprdmpF98_api.c \
	_coder_sprdmpF98_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF98_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF98"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF98/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF98/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF98/%.cu
	$(CC) $(CCFLAGS) "$<"
