...
MAKEFILE = sprdmpF44_mex.mk

include sprdmpF44_mex.mki


SRC_FILES =  \
	sprdmpF44_data.c \
	sprdmpF44_initialize.c \
	sprdmpF44_terminate.c \
	sprdmpF44.c \
	_coder_sprdmpF44_info.c \
	_coder_sprdmpF44_api.c \
	_coder_sprdmpF44_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF44_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF44"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF44/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF44/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF44/%.cu
	$(CC) $(CCFLAGS) "$<"
