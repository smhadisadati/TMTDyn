 ...
 *
 * Code generation for function '_coder_sprdmpF28_api'
 *
 */
...
#include "sprdmpF28.h"
#include "_coder_sprdmpF28_api.h"
#include "sprdmpF28_data.h"
...
void sprdmpF28_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray
                   *plhs[8])
{
  real_T (*out1)[106];
  real_T (*out6)[106];
  ...
  sprdmpF28(*in1, *in2, s, *out1, &out2, &out3, &out4, &out5, *out6, *out7,
            &out8);
...
/* End of code generation (_coder_sprdmpF28_api.c) */
