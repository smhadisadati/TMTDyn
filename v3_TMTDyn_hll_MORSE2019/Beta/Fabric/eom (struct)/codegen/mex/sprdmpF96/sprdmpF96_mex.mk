...
MAKEFILE = sprdmpF96_mex.mk

include sprdmpF96_mex.mki


SRC_FILES =  \
	sprdmpF96_data.c \
	sprdmpF96_initialize.c \
	sprdmpF96_terminate.c \
	sprdmpF96.c \
	_coder_sprdmpF96_info.c \
	_coder_sprdmpF96_api.c \
	_coder_sprdmpF96_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF96_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF96"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF96/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF96/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF96/%.cu
	$(CC) $(CCFLAGS) "$<"
