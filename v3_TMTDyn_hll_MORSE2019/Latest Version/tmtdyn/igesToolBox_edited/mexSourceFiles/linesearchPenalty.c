...
double linesearchPenalty(double *paramFinal, double *constrFcnMatrxs, double *paramStart, double *searchDirct, double *exponConstVal, double *pnltyParamVal, double *linzGrad, double *linzHess, double *quasum, double *datam, double *modelm, double *Spx, double *constTermCnsFcn, double *fcnStart, double *slopeStart, double *doubleVars){
    ...
    doubleVars[0]=sym6x6MatVecInnrProdSum(linzGrad, linzHess, paramFinal)+exponConstVal[0]*exp(pnltyParamVal[0]*constrFcnMatrxs[0]);
    ...
    doubleVars[1]=sym6x6MatVecInnrProdSum(linzGrad, linzHess, &doubleVars[3])+exponConstVal[0]*exp(pnltyParamVal[0]*constrFcnMatrxs[1]);
