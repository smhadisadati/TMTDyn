...
static void trfExpPenalty(double *paramFinal, unsigned char iters, double *paramConstrMin, double *linzGrad, double *linzHess, double *newtonStp, double *quasum, double *datam, double *modelm, double *Spx, double *constTermCnsFcn, double *doubleVars){
