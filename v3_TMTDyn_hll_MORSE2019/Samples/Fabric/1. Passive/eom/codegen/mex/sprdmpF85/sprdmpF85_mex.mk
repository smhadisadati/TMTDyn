...
MAKEFILE = sprdmpF85_mex.mk

include sprdmpF85_mex.mki


SRC_FILES =  \
	sprdmpF85_data.c \
	sprdmpF85_initialize.c \
	sprdmpF85_terminate.c \
	sprdmpF85.c \
	_coder_sprdmpF85_info.c \
	_coder_sprdmpF85_api.c \
	_coder_sprdmpF85_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF85_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF85"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF85/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF85/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF85/%.cu
	$(CC) $(CCFLAGS) "$<"
