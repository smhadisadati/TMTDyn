...
MAKEFILE = sprdmpF66_mex.mk

include sprdmpF66_mex.mki


SRC_FILES =  \
	sprdmpF66_data.c \
	sprdmpF66_initialize.c \
	sprdmpF66_terminate.c \
	sprdmpF66.c \
	_coder_sprdmpF66_info.c \
	_coder_sprdmpF66_api.c \
	_coder_sprdmpF66_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF66_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF66"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF66/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF66/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF66/%.cu
	$(CC) $(CCFLAGS) "$<"
