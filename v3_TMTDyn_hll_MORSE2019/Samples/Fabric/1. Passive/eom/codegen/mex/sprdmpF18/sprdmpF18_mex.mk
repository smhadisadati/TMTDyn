...
MAKEFILE = sprdmpF18_mex.mk

include sprdmpF18_mex.mki


SRC_FILES =  \
	sprdmpF18_data.c \
	sprdmpF18_initialize.c \
	sprdmpF18_terminate.c \
	sprdmpF18.c \
	_coder_sprdmpF18_info.c \
	_coder_sprdmpF18_api.c \
	_coder_sprdmpF18_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF18_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF18"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF18/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF18/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF18/%.cu
	$(CC) $(CCFLAGS) "$<"
