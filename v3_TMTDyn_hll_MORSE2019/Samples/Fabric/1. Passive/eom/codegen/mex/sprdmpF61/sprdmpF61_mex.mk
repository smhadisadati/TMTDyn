...
MAKEFILE = sprdmpF61_mex.mk

include sprdmpF61_mex.mki


SRC_FILES =  \
	sprdmpF61_data.c \
	sprdmpF61_initialize.c \
	sprdmpF61_terminate.c \
	sprdmpF61.c \
	_coder_sprdmpF61_info.c \
	_coder_sprdmpF61_api.c \
	_coder_sprdmpF61_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF61_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF61"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF61/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF61/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF61/%.cu
	$(CC) $(CCFLAGS) "$<"
