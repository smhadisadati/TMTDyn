...
MAKEFILE = sprdmpF71_mex.mk

include sprdmpF71_mex.mki


SRC_FILES =  \
	sprdmpF71_data.c \
	sprdmpF71_initialize.c \
	sprdmpF71_terminate.c \
	sprdmpF71.c \
	_coder_sprdmpF71_info.c \
	_coder_sprdmpF71_api.c \
	_coder_sprdmpF71_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF71_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF71"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF71/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF71/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF71/%.cu
	$(CC) $(CCFLAGS) "$<"
