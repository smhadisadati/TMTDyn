...
MAKEFILE = massF14_mex.mk

include massF14_mex.mki


SRC_FILES =  \
	massF14_data.c \
	massF14_initialize.c \
	massF14_terminate.c \
	massF14.c \
	error.c \
	sqrt.c \
	_coder_massF14_info.c \
	_coder_massF14_api.c \
	_coder_massF14_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = massF14_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/massF14"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/massF14/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/massF14/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/massF14/%.cu
	$(CC) $(CCFLAGS) "$<"
