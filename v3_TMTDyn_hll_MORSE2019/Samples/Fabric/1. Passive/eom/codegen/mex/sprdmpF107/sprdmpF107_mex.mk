...
MAKEFILE = sprdmpF107_mex.mk

include sprdmpF107_mex.mki


SRC_FILES =  \
	sprdmpF107_data.c \
	sprdmpF107_initialize.c \
	sprdmpF107_terminate.c \
	sprdmpF107.c \
	error.c \
	sqrt.c \
	_coder_sprdmpF107_info.c \
	_coder_sprdmpF107_api.c \
	_coder_sprdmpF107_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF107_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF107"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF107/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF107/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF107/%.cu
	$(CC) $(CCFLAGS) "$<"
