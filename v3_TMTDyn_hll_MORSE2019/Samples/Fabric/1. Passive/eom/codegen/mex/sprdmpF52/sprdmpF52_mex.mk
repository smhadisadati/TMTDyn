...
MAKEFILE = sprdmpF52_mex.mk

include sprdmpF52_mex.mki


SRC_FILES =  \
	sprdmpF52_data.c \
	sprdmpF52_initialize.c \
	sprdmpF52_terminate.c \
	sprdmpF52.c \
	_coder_sprdmpF52_info.c \
	_coder_sprdmpF52_api.c \
	_coder_sprdmpF52_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF52_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF52"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF52/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF52/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF52/%.cu
	$(CC) $(CCFLAGS) "$<"
