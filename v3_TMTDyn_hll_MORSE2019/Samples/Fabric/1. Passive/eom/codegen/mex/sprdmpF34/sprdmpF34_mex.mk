...
MAKEFILE = sprdmpF34_mex.mk

include sprdmpF34_mex.mki


SRC_FILES =  \
	sprdmpF34_data.c \
	sprdmpF34_initialize.c \
	sprdmpF34_terminate.c \
	sprdmpF34.c \
	_coder_sprdmpF34_info.c \
	_coder_sprdmpF34_api.c \
	_coder_sprdmpF34_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF34_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF34"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF34/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF34/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF34/%.cu
	$(CC) $(CCFLAGS) "$<"
