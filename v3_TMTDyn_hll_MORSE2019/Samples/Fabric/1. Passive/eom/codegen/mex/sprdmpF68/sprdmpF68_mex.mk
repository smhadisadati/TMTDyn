...
MAKEFILE = sprdmpF68_mex.mk

include sprdmpF68_mex.mki


SRC_FILES =  \
	sprdmpF68_data.c \
	sprdmpF68_initialize.c \
	sprdmpF68_terminate.c \
	sprdmpF68.c \
	_coder_sprdmpF68_info.c \
	_coder_sprdmpF68_api.c \
	_coder_sprdmpF68_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF68_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF68"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF68/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF68/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF68/%.cu
	$(CC) $(CCFLAGS) "$<"
