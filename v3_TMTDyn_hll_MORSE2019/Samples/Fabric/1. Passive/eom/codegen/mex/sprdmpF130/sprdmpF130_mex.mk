...
MAKEFILE = sprdmpF130_mex.mk

include sprdmpF130_mex.mki


SRC_FILES =  \
	sprdmpF130_data.c \
	sprdmpF130_initialize.c \
	sprdmpF130_terminate.c \
	sprdmpF130.c \
	error.c \
	sqrt.c \
...
MEX_FILE_NAME_WO_EXT = sprdmpF130_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF130"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF130/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF130/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF130/%.cu
	$(CC) $(CCFLAGS) "$<"
