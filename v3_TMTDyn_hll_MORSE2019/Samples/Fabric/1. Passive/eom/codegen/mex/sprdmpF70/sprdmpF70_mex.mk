...
MAKEFILE = sprdmpF70_mex.mk

include sprdmpF70_mex.mki


SRC_FILES =  \
	sprdmpF70_data.c \
	sprdmpF70_initialize.c \
	sprdmpF70_terminate.c \
	sprdmpF70.c \
	_coder_sprdmpF70_info.c \
	_coder_sprdmpF70_api.c \
	_coder_sprdmpF70_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF70_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF70"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF70/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF70/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF70/%.cu
	$(CC) $(CCFLAGS) "$<"
