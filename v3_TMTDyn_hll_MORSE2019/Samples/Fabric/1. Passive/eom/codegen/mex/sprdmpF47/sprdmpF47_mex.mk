...
MAKEFILE = sprdmpF47_mex.mk

include sprdmpF47_mex.mki


SRC_FILES =  \
	sprdmpF47_data.c \
	sprdmpF47_initialize.c \
	sprdmpF47_terminate.c \
	sprdmpF47.c \
	_coder_sprdmpF47_info.c \
	_coder_sprdmpF47_api.c \
	_coder_sprdmpF47_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF47_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF47"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF47/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF47/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF47/%.cu
	$(CC) $(CCFLAGS) "$<"
