...
MAKEFILE = sprdmpF77_mex.mk

include sprdmpF77_mex.mki


SRC_FILES =  \
	sprdmpF77_data.c \
	sprdmpF77_initialize.c \
	sprdmpF77_terminate.c \
	sprdmpF77.c \
	_coder_sprdmpF77_info.c \
	_coder_sprdmpF77_api.c \
	_coder_sprdmpF77_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF77_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF77"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF77/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF77/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF77/%.cu
	$(CC) $(CCFLAGS) "$<"
