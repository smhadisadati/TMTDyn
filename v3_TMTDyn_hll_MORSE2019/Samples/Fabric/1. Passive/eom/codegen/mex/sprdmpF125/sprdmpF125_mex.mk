...
MAKEFILE = sprdmpF125_mex.mk

include sprdmpF125_mex.mki


SRC_FILES =  \
	sprdmpF125_data.c \
	sprdmpF125_initialize.c \
	sprdmpF125_terminate.c \
	sprdmpF125.c \
	error.c \
	sqrt.c \
	_coder_sprdmpF125_info.c \
	_coder_sprdmpF125_api.c \
	_coder_sprdmpF125_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF125_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF125"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF125/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF125/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF125/%.cu
	$(CC) $(CCFLAGS) "$<"
