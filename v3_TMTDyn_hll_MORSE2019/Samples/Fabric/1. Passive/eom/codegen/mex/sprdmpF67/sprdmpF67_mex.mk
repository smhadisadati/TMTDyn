...
MAKEFILE = sprdmpF67_mex.mk

include sprdmpF67_mex.mki


SRC_FILES =  \
	sprdmpF67_data.c \
	sprdmpF67_initialize.c \
	sprdmpF67_terminate.c \
	sprdmpF67.c \
	_coder_sprdmpF67_info.c \
	_coder_sprdmpF67_api.c \
	_coder_sprdmpF67_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF67_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF67"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF67/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF67/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF67/%.cu
	$(CC) $(CCFLAGS) "$<"
