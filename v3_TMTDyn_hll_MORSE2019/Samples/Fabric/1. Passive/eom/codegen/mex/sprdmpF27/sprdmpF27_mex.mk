...
MAKEFILE = sprdmpF27_mex.mk

include sprdmpF27_mex.mki


SRC_FILES =  \
	sprdmpF27_data.c \
	sprdmpF27_initialize.c \
	sprdmpF27_terminate.c \
	sprdmpF27.c \
	_coder_sprdmpF27_info.c \
	_coder_sprdmpF27_api.c \
	_coder_sprdmpF27_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF27_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF27"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF27/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF27/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF27/%.cu
	$(CC) $(CCFLAGS) "$<"
