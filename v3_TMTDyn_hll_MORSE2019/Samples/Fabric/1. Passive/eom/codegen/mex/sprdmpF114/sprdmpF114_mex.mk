...
MAKEFILE = sprdmpF114_mex.mk

include sprdmpF114_mex.mki


SRC_FILES =  \
	sprdmpF114_data.c \
	sprdmpF114_initialize.c \
	sprdmpF114_terminate.c \
	sprdmpF114.c \
	error.c \
	sqrt.c \
	_coder_sprdmpF114_info.c \
	_coder_sprdmpF114_api.c \
	_coder_sprdmpF114_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF114_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF114"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF114/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF114/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF114/%.cu
	$(CC) $(CCFLAGS) "$<"
