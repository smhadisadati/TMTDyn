...
MAKEFILE = sprdmpF11_mex.mk

include sprdmpF11_mex.mki


SRC_FILES =  \
	sprdmpF11_data.c \
	sprdmpF11_initialize.c \
	sprdmpF11_terminate.c \
	sprdmpF11.c \
	_coder_sprdmpF11_info.c \
	_coder_sprdmpF11_api.c \
	_coder_sprdmpF11_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF11_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF11"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF11/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF11/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF11/%.cu
	$(CC) $(CCFLAGS) "$<"
