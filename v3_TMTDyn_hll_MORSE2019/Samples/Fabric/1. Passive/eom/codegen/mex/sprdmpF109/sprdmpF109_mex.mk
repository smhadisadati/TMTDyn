...
MAKEFILE = sprdmpF109_mex.mk

include sprdmpF109_mex.mki


SRC_FILES =  \
	sprdmpF109_data.c \
	sprdmpF109_initialize.c \
	sprdmpF109_terminate.c \
	sprdmpF109.c \
	error.c \
	sqrt.c \
	_coder_sprdmpF109_info.c \
	_coder_sprdmpF109_api.c \
	_coder_sprdmpF109_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF109_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF109"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF109/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF109/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF109/%.cu
	$(CC) $(CCFLAGS) "$<"
