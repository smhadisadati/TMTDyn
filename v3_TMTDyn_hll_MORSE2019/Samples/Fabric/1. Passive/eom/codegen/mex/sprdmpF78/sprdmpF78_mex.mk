...
MAKEFILE = sprdmpF78_mex.mk

include sprdmpF78_mex.mki


SRC_FILES =  \
	sprdmpF78_data.c \
	sprdmpF78_initialize.c \
	sprdmpF78_terminate.c \
	sprdmpF78.c \
	_coder_sprdmpF78_info.c \
	_coder_sprdmpF78_api.c \
	_coder_sprdmpF78_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF78_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF78"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF78/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF78/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF78/%.cu
	$(CC) $(CCFLAGS) "$<"
