...
MAKEFILE = sprdmpF28_mex.mk

include sprdmpF28_mex.mki


SRC_FILES =  \
	sprdmpF28_data.c \
	sprdmpF28_initialize.c \
	sprdmpF28_terminate.c \
	sprdmpF28.c \
	_coder_sprdmpF28_info.c \
	_coder_sprdmpF28_api.c \
	_coder_sprdmpF28_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF28_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF28"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF28/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF28/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF28/%.cu
	$(CC) $(CCFLAGS) "$<"
