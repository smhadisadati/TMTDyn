...
MAKEFILE = sprdmpF48_mex.mk

include sprdmpF48_mex.mki


SRC_FILES =  \
	sprdmpF48_data.c \
	sprdmpF48_initialize.c \
	sprdmpF48_terminate.c \
	sprdmpF48.c \
	_coder_sprdmpF48_info.c \
	_coder_sprdmpF48_api.c \
	_coder_sprdmpF48_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF48_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF48"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF48/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF48/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF48/%.cu
	$(CC) $(CCFLAGS) "$<"
