...
MAKEFILE = sprdmpF63_mex.mk

include sprdmpF63_mex.mki


SRC_FILES =  \
	sprdmpF63_data.c \
	sprdmpF63_initialize.c \
	sprdmpF63_terminate.c \
	sprdmpF63.c \
	_coder_sprdmpF63_info.c \
	_coder_sprdmpF63_api.c \
	_coder_sprdmpF63_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF63_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF63"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF63/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF63/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF63/%.cu
	$(CC) $(CCFLAGS) "$<"
