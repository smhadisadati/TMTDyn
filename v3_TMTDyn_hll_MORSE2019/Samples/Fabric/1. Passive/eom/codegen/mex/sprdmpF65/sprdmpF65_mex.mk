...
MAKEFILE = sprdmpF65_mex.mk

include sprdmpF65_mex.mki


SRC_FILES =  \
	sprdmpF65_data.c \
	sprdmpF65_initialize.c \
	sprdmpF65_terminate.c \
	sprdmpF65.c \
	_coder_sprdmpF65_info.c \
	_coder_sprdmpF65_api.c \
	_coder_sprdmpF65_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF65_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF65"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF65/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF65/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF65/%.cu
	$(CC) $(CCFLAGS) "$<"
