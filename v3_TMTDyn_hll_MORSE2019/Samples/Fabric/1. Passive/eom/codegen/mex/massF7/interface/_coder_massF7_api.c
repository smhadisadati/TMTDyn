...
void massF7_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray *
                plhs[4])
{
  real_T (*out1)[36];
  real_T (*out2)[636];
  ...
  massF7(&st, *in1, *in2, s, *out1, *out2, *out3, *out4);
...
/* End of code generation (_coder_massF7_api.c) */
