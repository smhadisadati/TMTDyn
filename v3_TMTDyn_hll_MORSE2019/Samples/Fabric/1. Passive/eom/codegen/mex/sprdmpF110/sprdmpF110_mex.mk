...
MAKEFILE = sprdmpF110_mex.mk

include sprdmpF110_mex.mki


SRC_FILES =  \
	sprdmpF110_data.c \
	sprdmpF110_initialize.c \
	sprdmpF110_terminate.c \
	sprdmpF110.c \
	error.c \
	sqrt.c \
	_coder_sprdmpF110_info.c \
	_coder_sprdmpF110_api.c \
	_coder_sprdmpF110_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF110_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF110"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF110/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF110/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF110/%.cu
	$(CC) $(CCFLAGS) "$<"
