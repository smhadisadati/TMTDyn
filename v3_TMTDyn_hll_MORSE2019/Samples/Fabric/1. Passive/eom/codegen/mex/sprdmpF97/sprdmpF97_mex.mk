...
MAKEFILE = sprdmpF97_mex.mk

include sprdmpF97_mex.mki


SRC_FILES =  \
	sprdmpF97_data.c \
	sprdmpF97_initialize.c \
	sprdmpF97_terminate.c \
	sprdmpF97.c \
	_coder_sprdmpF97_info.c \
	_coder_sprdmpF97_api.c \
	_coder_sprdmpF97_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF97_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF97"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF97/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF97/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF97/%.cu
	$(CC) $(CCFLAGS) "$<"
