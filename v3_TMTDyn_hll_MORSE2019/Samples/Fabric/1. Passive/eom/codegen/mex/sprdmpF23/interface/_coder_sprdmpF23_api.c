 ...
 *
 * Code generation for function '_coder_sprdmpF23_api'
 *
 */
...
#include "sprdmpF23.h"
#include "_coder_sprdmpF23_api.h"
...
void sprdmpF23_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray
                   *plhs[8])
{
  real_T (*out1)[106];
  real_T (*out6)[106];
  ...
  sprdmpF23(*in1, *in2, s, *out1, &out2, &out3, &out4, &out5, *out6, *out7,
            &out8);
...
/* End of code generation (_coder_sprdmpF23_api.c) */
