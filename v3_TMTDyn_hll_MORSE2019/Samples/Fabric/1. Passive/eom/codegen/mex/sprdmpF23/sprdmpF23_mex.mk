...
MAKEFILE = sprdmpF23_mex.mk

include sprdmpF23_mex.mki


SRC_FILES =  \
	sprdmpF23_data.c \
	sprdmpF23_initialize.c \
	sprdmpF23_terminate.c \
	sprdmpF23.c \
	_coder_sprdmpF23_info.c \
	_coder_sprdmpF23_api.c \
	_coder_sprdmpF23_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF23_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF23"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF23/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF23/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF23/%.cu
	$(CC) $(CCFLAGS) "$<"
