...
MAKEFILE = sprdmpF72_mex.mk

include sprdmpF72_mex.mki


SRC_FILES =  \
	sprdmpF72_data.c \
	sprdmpF72_initialize.c \
	sprdmpF72_terminate.c \
	sprdmpF72.c \
	_coder_sprdmpF72_info.c \
	_coder_sprdmpF72_api.c \
	_coder_sprdmpF72_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF72_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF72"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF72/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF72/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF72/%.cu
	$(CC) $(CCFLAGS) "$<"
