...
MAKEFILE = sprdmpF59_mex.mk

include sprdmpF59_mex.mki


SRC_FILES =  \
	sprdmpF59_data.c \
	sprdmpF59_initialize.c \
	sprdmpF59_terminate.c \
	sprdmpF59.c \
	_coder_sprdmpF59_info.c \
	_coder_sprdmpF59_api.c \
	_coder_sprdmpF59_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF59_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF59"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF59/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF59/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF59/%.cu
	$(CC) $(CCFLAGS) "$<"
