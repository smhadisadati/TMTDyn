               ...
               *out6)
{
  ...
  memset(&out1[11], 0, 13U * sizeof(double));
  out1[24] = t1907;
  ...
  memset(&out1[35], 0, 13U * sizeof(double));
  ...
  t844 = ((((((t988 * t418 + t999 * t686) + t120 * t1032_tmp) - t986 * t1209_tmp)
    ...
    t1681_tmp * t1289 / 4.0;
  out1[58] = t844;
  memset(&out1[59], 0, 13U * sizeof(double));
  ...
  memset(&out1[83], 0, 13U * sizeof(double));
  ...
  out1[106] = t9;
  memset(&out1[107], 0, 13U * sizeof(double));
  out1[120] = t1914;
  ...
  out1[129] = t1912;
  out1[130] = t1913;
  memset(&out1[131], 0, 13U * sizeof(double));
