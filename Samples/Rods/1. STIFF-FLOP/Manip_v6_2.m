...
par.simdyn = 2 ; % 1: dyn. sim. with Matlab func.s, 2: with C-mex func.s
...
switch study    
    case 1 % ROM
        l_ss = l_s_sym / n_rs ; % segment length
...
switch study
    ...
    case 1 % ROM
        ...
        % vz
        joint(i_j).dof(3).init = ( 1:n_rs ) * l_ss ; % fit a polynomial of order n_s to these points
    ...
    case 4 % EBA
        ...
        % vx, vy, ux, uy, uz: default dof values
        % vz
        joint(i_j).dof(3).init = ( 1:n_rs ).' * l_ss ;
