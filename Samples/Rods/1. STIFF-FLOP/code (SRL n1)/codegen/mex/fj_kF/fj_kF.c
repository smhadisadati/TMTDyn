...
void fj_kF(const emlrtStack *sp, const real_T in1[34], const real_T in2[12],
           real_T s, real_T fj_k[6])
{
  real_T t2;
  real_T t27;
  real_T t4;
  ...
  fj_k[3] = in1[1] * in2[3] * t2 * t4 * t27 * 3.1415926535897931 / 6.0;
  t27 = t27 * 3.1415926535897931 / 4.0 - t2 * t9 * t11 * (t14_tmp - 1.0) * (in1
    [19] * in1[19]) * 3.1415926535897931 * 3.0;
  fj_k[4] = in1[1] * in2[4] * t2 * t4 * t27;
  fj_k[5] = in1[1] * in2[5] * t2 * t4 * t27;
}
