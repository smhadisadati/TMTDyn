  ...
  emlrtMsgIdentifier *parentId, struct0_T *y)
{
  ...
  y->rom = q_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 40,
    "rom")), &thisId);
  thisId.fIdentifier = "par_mex";
  s_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 41, "par_mex")),
                     &thisId, &y->par_mex);
             ...
             const mxArray *plhs[1])
{
  ...
  dz_data = (real_T (*)[18])mxMalloc(sizeof(real_T [18]));
