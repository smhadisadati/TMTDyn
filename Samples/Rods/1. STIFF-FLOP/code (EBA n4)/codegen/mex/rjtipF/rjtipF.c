            ...
            real_T s, real_T r_jtip[30])
{
  ...
  r_jtip[17] = in2[12];
  r_jtip[18] = in2[18];
  r_jtip_tmp = in1[16] * in2[22];
  b_r_jtip_tmp = in1[16] * in2[21];
  r_jtip[19] = (in2[18] + b_r_jtip_tmp * in2[23] * 2.0) + r_jtip_tmp * t6 * 2.0;
  r_jtip[20] = in2[1];
  r_jtip[21] = in2[7];
  r_jtip[22] = in2[13];
  r_jtip[23] = in2[19];
  r_jtip[24] = (in2[19] + r_jtip_tmp * in2[23] * 2.0) - b_r_jtip_tmp * t6 * 2.0;
  r_jtip[25] = in2[2];
  r_jtip[26] = in2[8];
  r_jtip[27] = in2[14];
  r_jtip[28] = in2[20];
  r_jtip[29] = (((in2[20] - in1[16] * t2) - in1[16] * t3) + in1[16] * t4) - in1
    [16] * (((t2 + t3) + t4) - 1.0);
}
