  ...
  emlrtMsgIdentifier *msgId, real_T ret[30])
{
  ...
  real_T (*r7)[30];
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r7 = (real_T (*)[30])emlrtMxGetData(src);
  memcpy(&ret[0], &(*r7)[0], 30U * sizeof(real_T));
  emlrtDestroyArray(&src);
}
...
static void kb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, real_T ret[35])
{
  static const int32_T dims[2] = { 1, 35 };

  real_T (*r8)[35];
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r8 = (real_T (*)[35])emlrtMxGetData(src);
  memcpy(&ret[0], &(*r8)[0], 35U * sizeof(real_T));
  emlrtDestroyArray(&src);
}
             ...
             const mxArray *plhs[1])
{
  ...
  dz_data = (real_T (*)[90])mxMalloc(sizeof(real_T [90]));
