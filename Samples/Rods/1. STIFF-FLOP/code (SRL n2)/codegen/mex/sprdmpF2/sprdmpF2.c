...
static emlrtRSInfo emlrtRSI = { 24,    /* lineNo */
  "sprdmpF2",                          /* fcnName */
  "/home/hadi/MEGAsync/Hadi/AutoTMTDyn/Code/AutoTMTDyn/Beta/v1.0/code/sprdmpF2.m"/* pathName */
};
              ...
              real_T *out5, real_T out6[6], real_T out7[6], real_T *out8)
{
  ...
  *out2 = in1[1] * in2[1] * t2 * t4 * t16 * 3.1415926535897931 / 3.0;
  st.site = &g_emlrtRSI;
  b_st.site = &i_emlrtRSI;
  *out3 = -in1[6] * in2[7] * muDoubleScalarPower(muDoubleScalarAbs(in2[7]), in1
    [11] - 1.0);
  *out4 = 0.0;
  *out5 = in2[1];
  out6[0] = 0.0;
  ...
  out7[0] = 0.0;
  out7[1] = -in1[6] * muDoubleScalarPower(in2[7], in1[11] - 1.0);
  out7[2] = 0.0;
  out7[3] = 0.0;
  out7[4] = 0.0;
  out7[5] = 0.0;
