...
static const mxArray *b_emlrt_marshallOut(const real_T u_data[], const int32_T
  u_size[1]);
static uint64_T bb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
...
static void hb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, real_T ret[5545]);
...
static void l_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, real_T y[4436]);
...
static void m_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, real_T y[7763]);
static void mb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, real_T ret[28]);
static void n_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, real_T y[5545]);
...
static char_T ob_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
...
static void t_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, real_T y[28]);
...
static char_T w_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId);
  ...
  emlrtMsgIdentifier *parentId, struct0_T *y)
{
  ...
  p_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 22,
  ...
  q_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 35, "qf0")),
                     &thisId, y->qf0);
  ...
  r_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 40, "rom")),
                     &thisId, &y->rom);
  thisId.fIdentifier = "par_mex";
  u_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 41, "par_mex")),
                     &thisId, &y->par_mex);
  ...
  y->linetype = w_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0,
    44, "linetype")), &thisId);
  ...
  emlrtMsgIdentifier *msgId, real_T ret[4436])
{
  ...
  real_T (*r2)[4436];
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r2 = (real_T (*)[4436])emlrtMxGetData(src);
  memcpy(&ret[0], &(*r2)[0], 4436U * sizeof(real_T));
  emlrtDestroyArray(&src);
}
  ...
  emlrtMsgIdentifier *msgId, real_T ret[7763])
{
  ...
  real_T (*r3)[7763];
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r3 = (real_T (*)[7763])emlrtMxGetData(src);
  memcpy(&ret[0], &(*r3)[0], 7763U * sizeof(real_T));
  emlrtDestroyArray(&src);
}
  ...
  emlrtMsgIdentifier *msgId, real_T ret[5545])
{
  ...
  real_T (*r4)[5545];
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r4 = (real_T (*)[5545])emlrtMxGetData(src);
  memcpy(&ret[0], &(*r4)[0], 5545U * sizeof(real_T));
  emlrtDestroyArray(&src);
}
  ...
  emlrtMsgIdentifier *msgId, real_T ret[6])
{
  ...
  int32_T i1;
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r5 = (real_T (*)[6])emlrtMxGetData(src);
  for (i1 = 0; i1 < 6; i1++) {
    ret[i1] = (*r5)[i1];
  }
  ...
  emlrtMsgIdentifier *msgId, real_T ret[10])
{
  ...
  real_T (*r6)[10];
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r6 = (real_T (*)[10])emlrtMxGetData(src);
  memcpy(&ret[0], &(*r6)[0], 10U * sizeof(real_T));
  emlrtDestroyArray(&src);
}
  ...
  emlrtMsgIdentifier *msgId, real_T ret[24])
{
  ...
  real_T (*r7)[24];
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r7 = (real_T (*)[24])emlrtMxGetData(src);
  memcpy(&ret[0], &(*r7)[0], 24U * sizeof(real_T));
  emlrtDestroyArray(&src);
}
  ...
  emlrtMsgIdentifier *msgId, real_T ret[5])
{
  ...
  int32_T i2;
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r8 = (real_T (*)[5])emlrtMxGetData(src);
  for (i2 = 0; i2 < 5; i2++) {
    ret[i2] = (*r8)[i2];
  }
  ...
  emlrtMsgIdentifier *msgId, real_T ret[28])
{
  ...
  real_T (*r9)[28];
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r9 = (real_T (*)[28])emlrtMxGetData(src);
  memcpy(&ret[0], &(*r9)[0], 28U * sizeof(real_T));
  emlrtDestroyArray(&src);
}
  ...
  emlrtMsgIdentifier *msgId, real_T ret[4])
{
  ...
  real_T (*r10)[4];
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r10 = (real_T (*)[4])emlrtMxGetData(src);
  ret[0] = (*r10)[0];
  ret[1] = (*r10)[1];
  ret[2] = (*r10)[2];
  ret[3] = (*r10)[3];
  ...
  emlrtMsgIdentifier *parentId, struct1_T *y)
{
  ...
  s_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 0, "mass")),
                     &thisId, y->mass);
  thisId.fIdentifier = "sprdmp";
  t_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 1, "sprdmp")),
                     &thisId, y->sprdmp);
  emlrtDestroyArray(&u);
}
  ...
  emlrtMsgIdentifier *parentId, struct2_T *y)
{
  ...
  y->timer = h_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 1,
    "timer")), &thisId);
  thisId.fIdentifier = "elapsed_time";
  v_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 2,
    "elapsed_time")), &thisId, y->elapsed_time);
  thisId.fIdentifier = "derive";
  y->derive = b_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 3,
    "derive")), &thisId);
               ...
               const mxArray *plhs[1])
{
  ...
  dz_data = (real_T (*)[72])mxMalloc(sizeof(real_T [72]));
