 ...
 * _coder_fj_vdF_api.c
 *
 * Code generation for function '_coder_fj_vdF_api'
 *
 */
...
void fj_vdF_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray *
                plhs[1])
{
  real_T (*fj_vd)[18];
  real_T (*in1)[34];
  ...
  fj_vd = (real_T (*)[18])mxMalloc(sizeof(real_T [18]));
  ...
  fj_vdF(*in1, *in2, s, *fj_vd);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*fj_vd);
}

/* End of code generation (_coder_fj_vdF_api.c) */
