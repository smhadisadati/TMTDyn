 ...
 *
 * Code generation for function '_coder_loadsF1_api'
 *
 */
...
void loadsF1_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray
                 *plhs[2])
{
  real_T (*out1)[108];
  real_T (*out2)[6];
  ...
  loadsF1(&st, *in1, *in2, s, *out1, *out2);
...
/* End of code generation (_coder_loadsF1_api.c) */
