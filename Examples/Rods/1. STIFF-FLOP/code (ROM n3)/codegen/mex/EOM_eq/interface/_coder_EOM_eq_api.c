...
static const mxArray *d_emlrt_marshallOut(const real_T u[18]);
...
static const mxArray *d_emlrt_marshallOut(const real_T u[18])
{
  ...
  static const int32_T iv16[1] = { 18 };

  y = NULL;
  m46 = emlrtCreateNumericArray(1, iv15, mxDOUBLE_CLASS, mxREAL);
  emlrtMxSetData((mxArray *)m46, (void *)&u[0]);
  emlrtSetDimensions((mxArray *)m46, iv16, 1);
  emlrtAssign(&y, m46);
  return y;
}
                  ...
                  *plhs[1])
{
  ...
  fval = (real_T (*)[18])mxMalloc(sizeof(real_T [18]));
