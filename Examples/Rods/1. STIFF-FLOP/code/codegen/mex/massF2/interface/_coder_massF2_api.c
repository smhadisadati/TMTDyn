...
static const mxArray *b_emlrt_marshallOut(const real_T u[72]);
  ...
  static const mxArray *b_emlrt_marshallOut(const real_T u[72])
{
  ...
  static const int32_T iv3[2] = { 6, 12 };
                ...
                plhs[4])
{
  ...
  out2 = (real_T (*)[72])mxMalloc(sizeof(real_T [72]));
  out3 = (real_T (*)[72])mxMalloc(sizeof(real_T [72]));
