...
static const mxArray *b_emlrt_marshallOut(const real_T u[4376])
{
  const mxArray *y;
  const mxArray *m37;
  static const int32_T iv10[2] = { 1094, 4 };
  ...
  pData = emlrtMxGetPr(m37);
  i3 = 0;
  for (i = 0; i < 4; i++) {
    for (b_i = 0; b_i < 1094; b_i++) {
      pData[i3] = u[b_i + 1094 * i];
      i3++;
    }
  }
...
static const mxArray *c_emlrt_marshallOut(const real_T u[9])
{
  ...
  int32_T i;
  y = NULL;
  m38 = emlrtCreateNumericArray(2, iv11, mxDOUBLE_CLASS, mxREAL);
...
static const mxArray *emlrt_marshallOut(const b_struct_T *u)
{
  ...
  int32_T i;
  const mxArray *m17;
  static const int32_T iv4[2] = { 1094, 7 };

  real_T *c_pData;
  int32_T b_i;
  const mxArray *m18;
  static const int32_T iv5[2] = { 1094, 5 };
  ...
  const mxArray *m29;
  const mxArray *m30;
  static const int32_T iv7[2] = { 1, 12 };
  ...
  *(uint64_T *)emlrtMxGetData(m1) = u->timer;
  ...
  for (i = 0; i < 5; i++) {
    for (b_i = 0; b_i < 1094; b_i++) {
      d_pData[i2] = u->tip_RQ[b_i + 1094 * i];
      i2++;
    }
  }
  ...
  b_y = NULL;
  m21 = emlrtCreateDoubleScalar(u->dt);
  emlrtAssign(&b_y, m21);
  emlrtSetFieldR2017b(y, 0, "dt", b_y, 26);
  b_y = NULL;
  m22 = emlrtCreateDoubleScalar(u->stepT);
  emlrtAssign(&b_y, m22);
  ...
  b_y = NULL;
  m24 = emlrtCreateDoubleScalar(u->skip);
  emlrtAssign(&b_y, m24);
  emlrtSetFieldR2017b(y, 0, "skip", b_y, 29);
  b_y = NULL;
  m25 = emlrtCreateDoubleScalar(u->animPause);
  emlrtAssign(&b_y, m25);
  emlrtSetFieldR2017b(y, 0, "animPause", b_y, 30);
  b_y = NULL;
  m26 = emlrtCreateDoubleScalar(u->pause);
  emlrtAssign(&b_y, m26);
  emlrtSetFieldR2017b(y, 0, "pause", b_y, 31);
  b_y = NULL;
  m27 = emlrtCreateDoubleScalar(u->t_equil_i);
  emlrtAssign(&b_y, m27);
  emlrtSetFieldR2017b(y, 0, "t_equil_i", b_y, 32);
  b_y = NULL;
  m28 = emlrtCreateDoubleScalar(u->nq);
  emlrtAssign(&b_y, m28);
  emlrtSetFieldR2017b(y, 0, "nq", b_y, 33);
  b_y = NULL;
  m29 = emlrtCreateDoubleScalar(u->nlambda);
  emlrtAssign(&b_y, m29);
  emlrtSetFieldR2017b(y, 0, "nlambda", b_y, 34);
  b_y = NULL;
  m30 = emlrtCreateNumericArray(2, iv7, mxDOUBLE_CLASS, mxREAL);
  e_pData = emlrtMxGetPr(m30);
  i2 = 0;
  for (i = 0; i < 12; i++) {
    e_pData[i2] = u->qf0[i];
    i2++;
  ...
  b_y = NULL;
  m31 = emlrtCreateDoubleScalar(u->n_m);
  emlrtAssign(&b_y, m31);
  emlrtSetFieldR2017b(y, 0, "n_m", b_y, 36);
  b_y = NULL;
  m32 = emlrtCreateDoubleScalar(u->n_sd);
  emlrtAssign(&b_y, m32);
  emlrtSetFieldR2017b(y, 0, "n_sd", b_y, 37);
  b_y = NULL;
  m33 = emlrtCreateDoubleScalar(u->n_cn);
  emlrtAssign(&b_y, m33);
  emlrtSetFieldR2017b(y, 0, "n_cn", b_y, 38);
  b_y = NULL;
  m34 = emlrtCreateDoubleScalar(u->n_ex);
  emlrtAssign(&b_y, m34);
  emlrtSetFieldR2017b(y, 0, "n_ex", b_y, 39);
  b_y = NULL;
  emlrtAssign(&b_y, emlrtCreateStructMatrix(1, 1, 2, sv1));
  c_y = NULL;
  m35 = emlrtCreateNumericArray(2, iv8, mxDOUBLE_CLASS, mxREAL);
  f_pData = emlrtMxGetPr(m35);
  f_pData[0] = u->rom.mass[0];
  f_pData[1] = u->rom.mass[1];
  emlrtAssign(&c_y, m35);
  emlrtSetFieldR2017b(b_y, 0, "mass", c_y, 0);
  c_y = NULL;
  m36 = emlrtCreateNumericArray(2, iv9, mxDOUBLE_CLASS, mxREAL);
  g_pData = emlrtMxGetPr(m36);
  i2 = 0;
  for (i = 0; i < 13; i++) {
    g_pData[i2] = u->rom.sprdmp[i];
    i2++;
  }
