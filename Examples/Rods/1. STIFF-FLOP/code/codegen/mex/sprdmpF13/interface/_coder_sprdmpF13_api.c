 ...
 *
 * Code generation for function '_coder_sprdmpF13_api'
 *
 */
...
#include "sprdmpF13.h"
#include "_coder_sprdmpF13_api.h"
...
static const mxArray *d_emlrt_marshallOut(const real_T u[72]);
  ...
  static const mxArray *d_emlrt_marshallOut(const real_T u[72])
{
  ...
  static const int32_T iv7[2] = { 6, 12 };
  ...
  static const mxArray *emlrt_marshallOut(const real_T u[72])
{
  ...
  static const int32_T iv1[2] = { 12, 6 };
...
void sprdmpF13_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray
                   *plhs[8])
{
  real_T (*out1)[72];
  real_T (*out2)[6];
  ...
  out6 = (real_T (*)[72])mxMalloc(sizeof(real_T [72]));
  out7 = (real_T (*)[72])mxMalloc(sizeof(real_T [72]));
  ...
  sprdmpF13(&st, *in1, *in2, s, *out1, *out2, *out3, *out4, *out5, *out6, *out7,
            &out8);
...
/* End of code generation (_coder_sprdmpF13_api.c) */
