            ...
            real_T s, real_T r_jtip[36])
{
  ...
  b_in2[21] = in2[18];
  b_in2[22] = in2[24];
  b_in2[23] = (in2[24] + in1[16] * in2[27] * in2[29] * 2.0) + in1[16] * in2[28] *
    t5 * 2.0;
  b_in2[24] = in2[1];
  b_in2[25] = in2[7];
  b_in2[26] = in2[13];
  b_in2[27] = in2[19];
  b_in2[28] = in2[25];
  b_in2[29] = (in2[25] + in1[16] * in2[28] * in2[29] * 2.0) - in1[16] * in2[27] *
    t5 * 2.0;
  b_in2[30] = in2[2];
  b_in2[31] = in2[8];
  b_in2[32] = in2[14];
  b_in2[33] = in2[20];
  b_in2[34] = in2[26];
  b_in2[35] = (((in2[26] - in1[16] * t2) - in1[16] * t3) + in1[16] * t4) - in1
    [16] * (((t2 + t3) + t4) - 1.0);
  for (i0 = 0; i0 < 6; i0++) {
    for (i1 = 0; i1 < 6; i1++) {
