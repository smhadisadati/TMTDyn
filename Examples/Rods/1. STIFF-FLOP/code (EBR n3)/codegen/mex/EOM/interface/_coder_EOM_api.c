...
static char_T kb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
...
static char_T u_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId);
...
static uint64_T y_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
  ...
  emlrtMsgIdentifier *parentId))[36]
{
  ...
  const emlrtMsgIdentifier *msgId, real_T ret[4436])
{
  ...
  emlrtMsgIdentifier *parentId, struct0_T *y)
{
  ...
  y->linetype = u_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0,
    44, "linetype")), &thisId);
