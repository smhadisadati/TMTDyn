                  ...
                  *plhs[8])
{
  ...
  out6 = (real_T (*)[36])mxMalloc(sizeof(real_T [36]));
  out7 = (real_T (*)[36])mxMalloc(sizeof(real_T [36]));
  ...
  sprdmpF7(&st, *in1, *in2, s, *out1, *out2, *out3, *out4, *out5, *out6, *out7,
           &out8);
  ...
  if (nlhs > 7) {
    plhs[7] = d_emlrt_marshallOut(out8);
  }
}
