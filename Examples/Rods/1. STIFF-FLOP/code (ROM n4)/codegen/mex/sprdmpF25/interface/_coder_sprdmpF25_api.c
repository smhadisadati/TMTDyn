  ...
  static const mxArray *d_emlrt_marshallOut(const real_T u[144])
{
  ...
  static const int32_T iv7[2] = { 6, 24 };
                   ...
                   *plhs[8])
{
  ...
  out1 = (real_T (*)[144])mxMalloc(sizeof(real_T [144]));
  ...
  out6 = (real_T (*)[144])mxMalloc(sizeof(real_T [144]));
  out7 = (real_T (*)[144])mxMalloc(sizeof(real_T [144]));
  ...
  sprdmpF25(&st, *in1, *in2, s, *out1, *out2, *out3, *out4, *out5, *out6, *out7,
            &out8);
