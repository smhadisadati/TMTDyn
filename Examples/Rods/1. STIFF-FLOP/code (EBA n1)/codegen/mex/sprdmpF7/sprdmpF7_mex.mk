...
MAKEFILE = sprdmpF7_mex.mk

include sprdmpF7_mex.mki


SRC_FILES =  \
	sprdmpF7_data.c \
	sprdmpF7_initialize.c \
	sprdmpF7_terminate.c \
	sprdmpF7.c \
	error.c \
	_coder_sprdmpF7_info.c \
	_coder_sprdmpF7_api.c \
	_coder_sprdmpF7_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF7_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF7"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF7/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF7/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF7/%.cu
	$(CC) $(CCFLAGS) "$<"
