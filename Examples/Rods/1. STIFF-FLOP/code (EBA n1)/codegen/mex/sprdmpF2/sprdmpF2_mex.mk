...
MAKEFILE = sprdmpF2_mex.mk

include sprdmpF2_mex.mki


SRC_FILES =  \
	sprdmpF2_data.c \
	sprdmpF2_initialize.c \
	sprdmpF2_terminate.c \
	sprdmpF2.c \
	_coder_sprdmpF2_info.c \
	_coder_sprdmpF2_api.c \
	_coder_sprdmpF2_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF2_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF2"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF2/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF2/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF2/%.cu
	$(CC) $(CCFLAGS) "$<"
