...
MAKEFILE = sprdmpF1_mex.mk

include sprdmpF1_mex.mki


SRC_FILES =  \
	sprdmpF1_data.c \
	sprdmpF1_initialize.c \
	sprdmpF1_terminate.c \
	sprdmpF1.c \
	_coder_sprdmpF1_info.c \
	_coder_sprdmpF1_api.c \
	_coder_sprdmpF1_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF1_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF1"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF1/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF1/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF1/%.cu
	$(CC) $(CCFLAGS) "$<"
