...
MAKEFILE = loadsF1_mex.mk

include loadsF1_mex.mki


SRC_FILES =  \
	loadsF1_data.c \
	loadsF1_initialize.c \
	loadsF1_terminate.c \
	loadsF1.c \
	error.c \
	_coder_loadsF1_info.c \
	_coder_loadsF1_api.c \
	_coder_loadsF1_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = loadsF1_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/loadsF1"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/loadsF1/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/loadsF1/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/loadsF1/%.cu
	$(CC) $(CCFLAGS) "$<"
