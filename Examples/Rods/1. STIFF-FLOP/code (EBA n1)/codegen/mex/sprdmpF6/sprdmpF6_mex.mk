...
MAKEFILE = sprdmpF6_mex.mk

include sprdmpF6_mex.mki


SRC_FILES =  \
	sprdmpF6_data.c \
	sprdmpF6_initialize.c \
	sprdmpF6_terminate.c \
	sprdmpF6.c \
	_coder_sprdmpF6_info.c \
	_coder_sprdmpF6_api.c \
	_coder_sprdmpF6_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF6_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF6"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF6/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF6/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF6/%.cu
	$(CC) $(CCFLAGS) "$<"
