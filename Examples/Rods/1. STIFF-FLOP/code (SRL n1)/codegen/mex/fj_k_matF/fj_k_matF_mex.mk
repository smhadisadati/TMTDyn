...
MAKEFILE = fj_k_matF_mex.mk

include fj_k_matF_mex.mki


SRC_FILES =  \
	fj_k_matF_data.c \
	fj_k_matF_initialize.c \
	fj_k_matF_terminate.c \
	fj_k_matF.c \
...
MEX_FILE_NAME_WO_EXT = fj_k_matF_mex
...
SYS_INCLUDE += -I "/home/hadi/MEGAsync/Hadi/AutoTMTDyn/Code/AutoTMTDyn/Beta/v1.0/code/codegen/mex/fj_k_matF"
...
%.$(OBJEXT) : /home/hadi/MEGAsync/Hadi/AutoTMTDyn/Code/AutoTMTDyn/Beta/v1.0/code/codegen/mex/fj_k_matF/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/MEGAsync/Hadi/AutoTMTDyn/Code/AutoTMTDyn/Beta/v1.0/code/codegen/mex/fj_k_matF/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/MEGAsync/Hadi/AutoTMTDyn/Code/AutoTMTDyn/Beta/v1.0/code/codegen/mex/fj_k_matF/%.cu
	$(CC) $(CCFLAGS) "$<"
