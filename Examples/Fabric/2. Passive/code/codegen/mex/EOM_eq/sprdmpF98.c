...
static emlrtRSInfo xn_emlrtRSI = { 40, /* lineNo */
  "sprdmpF98",                         /* fcnName */
  "/home/hadi/MEGAsync/Hadi/AutoTMTDyn/Code/AutoTMTDyn/Beta/v1.0/Fabric/code/sprdmpF98.m"/* pathName */
};

static emlrtRSInfo co_emlrtRSI = { 49, /* lineNo */
  "sprdmpF98",                         /* fcnName */
  "/home/hadi/MEGAsync/Hadi/AutoTMTDyn/Code/AutoTMTDyn/Beta/v1.0/Fabric/code/sprdmpF98.m"/* pathName */
};

static emlrtRSInfo do_emlrtRSI = { 57, /* lineNo */
  "sprdmpF98",                         /* fcnName */
  "/home/hadi/MEGAsync/Hadi/AutoTMTDyn/Code/AutoTMTDyn/Beta/v1.0/Fabric/code/sprdmpF98.m"/* pathName */
};
...
void sprdmpF98(const emlrtStack *sp, const real_T in1[6], const real_T in2[198],
               real_T out1[546], real_T out2[6], real_T out3[6], real_T out4[6])
{
  ...
  t213 = in2[13] - in2[67];
  t159 = in2[14] - in2[68];
  t26_tmp = in2[12] - in2[66];
  t28_tmp = in2[69] * t23;
  t28 = (-in2[14] + in2[68]) + t28_tmp * t213;
  ...
  t37 = t185 - t46_tmp;
  t39_tmp = in2[70] * t23;
  t39 = (-in2[12] + in2[66]) + t39_tmp * t159;
  ...
  t57 = (-in2[13] + in2[67]) + t55_tmp * t26_tmp;
  t59 = in2[15] * 2.0;
  ...
  t89 = muDoubleScalarPower(muDoubleScalarAbs((((((((t74 * in2[169] + t79 * in2
    [170]) + t66 * in2[111]) + t68 * in2[113]) + t67 * in2[166]) - t66 * in2[165])
    - t67 * in2[112]) - t68 * in2[167]) - t70 * in2[168]), in1[1] - 1.0);
  t94 = t34_tmp * 2.0;
  t222 *= t23;
  t95 = t222 * t26_tmp;
  t96 = in2[71] * t57;
  ...
  t120 = muDoubleScalarPower(muDoubleScalarAbs((((((((t106 * in2[168] + t111 *
    in2[170]) + t98 * in2[112]) + t99 * in2[111]) + t100 * in2[167]) - t98 *
    in2[166]) - t100 * in2[113]) - t99 * in2[165]) - t102 * in2[169]), in1[1] -
    1.0);
  t125 = in2[69] * t28;
  t126 = t53_tmp * 2.0;
  t127 = t36_tmp * 2.0;
  ...
  t151 = muDoubleScalarPower(muDoubleScalarAbs((((((((t137 * in2[168] + t142 *
    in2[169]) + t129 * in2[113]) + t131 * in2[112]) + t130 * in2[165]) - t129 *
    in2[167]) - t130 * in2[111]) - t131 * in2[166]) - t133 * in2[170]), in1[1] -
    1.0);
  t156 = in2[16] * 2.0;
  t158 = t16 + in2[15] * in2[69] * t15 * 2.0;
  t159 = in2[71] * 2.0;
  t161 = t159 + in2[16] * in2[69] * t15 * 2.0;
  t30 = in2[17] * in2[69] * t15 * 2.0;
  t28 = t5 * 2.0;
  ...
  t180 = muDoubleScalarPower(muDoubleScalarAbs(((((t169 * in2[168] + t165 * in2
    [169]) + t174 * in2[170]) + t176 * in2[116]) - t158 * in2[114]) - t161 *
    in2[115]), in1[1] - 1.0);
  t184 = t16 + in2[16] * in2[70] * t15 * 2.0;
  t185 = in2[15] * in2[70] * t15 * 2.0;
  t186 = in2[69] * 2.0;
  t188 = t186 + in2[17] * in2[70] * t15 * 2.0;
  ...
  t204 = muDoubleScalarPower(muDoubleScalarAbs(((((t193 * in2[169] + t190 * in2
    [168]) + t198 * in2[170]) + t200 * in2[114]) - t184 * in2[115]) - t188 *
    in2[116]), in1[1] - 1.0);
  t208 = t16 + in2[17] * in2[71] * t15 * 2.0;
  t16 = t17 + in2[15] * in2[71] * t15 * 2.0;
  t211 = in2[16] * in2[71] * t15 * 2.0;
  ...
  t19 = muDoubleScalarPower(muDoubleScalarAbs(((((t185 * in2[170] + t213 * in2
    [168]) + t159 * in2[169]) + t222 * in2[115]) - t208 * in2[116]) - t16 * in2
    [114]), in1[1] - 1.0);
  ...
  out2[2] = in1[0] * ((((-37.63342084446974 + in2[70] * t37) - in2[69] * t45) +
  ...
  t5 = in1[2] * t67 * t89;
  t28 = in1[2] * t68 * t89;
  out3[0] = (((((((t10_tmp * in2[111] - t5 * in2[112]) + t28 * in2[113]) -
  ...
  t5 = in1[2] * t99 * t120;
  t28 = in1[2] * t100 * t120;
  out3[1] = (((((((t10_tmp * in2[112] + t5 * in2[111]) - t28 * in2[113]) -
  ...
  t5 = in1[2] * t131 * t151;
  out3[2] = (((((((-in1[2] * t130 * t151 * in2[111] + t10_tmp * in2[113]) + t5 *
                  in2[112]) + in1[2] * t130 * t151 * in2[165]) - t10_tmp * in2
                [167]) - t5 * in2[166]) - in1[2] * t133 * t151 * in2[170]) +
             in1[2] * t137 * t151 * in2[168]) + in1[2] * t142 * t151 * in2[169];
  out3[3] = ((((-in1[3] * t158 * t180 * in2[114] - in1[3] * t161 * t180 * in2
                [115]) + in1[3] * t176 * t180 * in2[116]) + in1[3] * t165 * t180
              * in2[169]) + in1[3] * t169 * t180 * in2[168]) + in1[3] * t174 *
    t180 * in2[170];
  out3[4] = ((((-in1[3] * t184 * t204 * in2[115] - in1[3] * t188 * t204 * in2
                [116]) + in1[3] * t200 * t204 * in2[114]) + in1[3] * t190 * t204
              * in2[168]) + in1[3] * t193 * t204 * in2[169]) + in1[3] * t198 *
    t204 * in2[170];
  out3[5] = ((((-in1[3] * t208 * t19 * in2[116] - in1[3] * t16 * t19 * in2[114])
               + in1[3] * t222 * t19 * in2[115]) + in1[3] * t213 * t19 * in2[168])
