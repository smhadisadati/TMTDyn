...
MAKEFILE = sprdmpF35_mex.mk

include sprdmpF35_mex.mki


SRC_FILES =  \
	sprdmpF35_data.c \
	sprdmpF35_initialize.c \
	sprdmpF35_terminate.c \
	sprdmpF35.c \
	_coder_sprdmpF35_info.c \
	_coder_sprdmpF35_api.c \
	_coder_sprdmpF35_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF35_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF35"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF35/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF35/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF35/%.cu
	$(CC) $(CCFLAGS) "$<"
