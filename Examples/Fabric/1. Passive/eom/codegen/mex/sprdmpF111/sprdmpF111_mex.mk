...
MAKEFILE = sprdmpF111_mex.mk

include sprdmpF111_mex.mki


SRC_FILES =  \
	sprdmpF111_data.c \
	sprdmpF111_initialize.c \
	sprdmpF111_terminate.c \
	sprdmpF111.c \
	error.c \
	sqrt.c \
	_coder_sprdmpF111_info.c \
	_coder_sprdmpF111_api.c \
	_coder_sprdmpF111_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF111_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF111"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF111/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF111/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF111/%.cu
	$(CC) $(CCFLAGS) "$<"
