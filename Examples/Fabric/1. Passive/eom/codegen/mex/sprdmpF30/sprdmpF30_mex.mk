...
MAKEFILE = sprdmpF30_mex.mk

include sprdmpF30_mex.mki


SRC_FILES =  \
	sprdmpF30_data.c \
	sprdmpF30_initialize.c \
	sprdmpF30_terminate.c \
	sprdmpF30.c \
	_coder_sprdmpF30_info.c \
	_coder_sprdmpF30_api.c \
	_coder_sprdmpF30_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF30_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF30"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF30/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF30/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF30/%.cu
	$(CC) $(CCFLAGS) "$<"
