...
MAKEFILE = sprdmpF99_mex.mk

include sprdmpF99_mex.mki


SRC_FILES =  \
	sprdmpF99_data.c \
	sprdmpF99_initialize.c \
	sprdmpF99_terminate.c \
	sprdmpF99.c \
	_coder_sprdmpF99_info.c \
	_coder_sprdmpF99_api.c \
	_coder_sprdmpF99_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF99_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF99"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF99/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF99/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF99/%.cu
	$(CC) $(CCFLAGS) "$<"
