...
MAKEFILE = sprdmpF76_mex.mk

include sprdmpF76_mex.mki


SRC_FILES =  \
	sprdmpF76_data.c \
	sprdmpF76_initialize.c \
	sprdmpF76_terminate.c \
	sprdmpF76.c \
	_coder_sprdmpF76_info.c \
	_coder_sprdmpF76_api.c \
	_coder_sprdmpF76_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF76_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF76"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF76/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF76/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF76/%.cu
	$(CC) $(CCFLAGS) "$<"
