...
MAKEFILE = sprdmpF13_mex.mk

include sprdmpF13_mex.mki
...
SRC_FILES =  \
	...
	sprdmpF13.c \
	_coder_sprdmpF13_info.c \
	_coder_sprdmpF13_api.c \
	_coder_sprdmpF13_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF13_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF13"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF13/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF13/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF13/%.cu
	$(CC) $(CCFLAGS) "$<"
