 ...
 *
 * _coder_sprdmpF127_api.c
 *
 * Code generation for function '_coder_sprdmpF127_api'
 *
 */
...
#include "_coder_sprdmpF127_api.h"
...
static const mxArray *d_emlrt_marshallOut(const real_T u[318]);
...
static real_T (*emlrt_marshallIn(const emlrtStack *sp, const mxArray *in1, const
  char_T *identifier))[6];
static const mxArray *emlrt_marshallOut(const real_T u[318]);
  ...
  static const mxArray *d_emlrt_marshallOut(const real_T u[318])
{
  ...
  static const int32_T iv5[2] = { 3, 106 };
  ...
  static const mxArray *emlrt_marshallOut(const real_T u[318])
{
  ...
  static const int32_T iv1[2] = { 106, 3 };
...
void sprdmpF127_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray
                    *plhs[8])
{
  real_T (*out1)[318];
  real_T (*out2)[3];
  ...
  out1 = (real_T (*)[318])mxMalloc(sizeof(real_T [318]));
  out2 = (real_T (*)[3])mxMalloc(sizeof(real_T [3]));
  out3 = (real_T (*)[3])mxMalloc(sizeof(real_T [3]));
  out4 = (real_T (*)[3])mxMalloc(sizeof(real_T [3]));
  out6 = (real_T (*)[318])mxMalloc(sizeof(real_T [318]));
  out7 = (real_T (*)[318])mxMalloc(sizeof(real_T [318]));
  ...
  sprdmpF127(&st, *in1, *in2, s, *out1, *out2, *out3, *out4, &out5, *out6, *out7,
             &out8);
...
/* End of code generation (_coder_sprdmpF127_api.c) */
