...
MAKEFILE = sprdmpF64_mex.mk

include sprdmpF64_mex.mki


SRC_FILES =  \
	sprdmpF64_data.c \
	sprdmpF64_initialize.c \
	sprdmpF64_terminate.c \
	sprdmpF64.c \
	_coder_sprdmpF64_info.c \
	_coder_sprdmpF64_api.c \
	_coder_sprdmpF64_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF64_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF64"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF64/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF64/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF64/%.cu
	$(CC) $(CCFLAGS) "$<"
