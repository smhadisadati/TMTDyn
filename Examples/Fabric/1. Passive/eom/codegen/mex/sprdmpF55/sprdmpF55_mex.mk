...
MAKEFILE = sprdmpF55_mex.mk

include sprdmpF55_mex.mki


SRC_FILES =  \
	sprdmpF55_data.c \
	sprdmpF55_initialize.c \
	sprdmpF55_terminate.c \
	sprdmpF55.c \
	_coder_sprdmpF55_info.c \
	_coder_sprdmpF55_api.c \
	_coder_sprdmpF55_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF55_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF55"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF55/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF55/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF55/%.cu
	$(CC) $(CCFLAGS) "$<"
