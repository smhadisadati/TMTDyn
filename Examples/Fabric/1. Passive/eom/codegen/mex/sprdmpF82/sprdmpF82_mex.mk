...
MAKEFILE = sprdmpF82_mex.mk

include sprdmpF82_mex.mki


SRC_FILES =  \
	sprdmpF82_data.c \
	sprdmpF82_initialize.c \
	sprdmpF82_terminate.c \
	sprdmpF82.c \
	_coder_sprdmpF82_info.c \
	_coder_sprdmpF82_api.c \
	_coder_sprdmpF82_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF82_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF82"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF82/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF82/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF82/%.cu
	$(CC) $(CCFLAGS) "$<"
