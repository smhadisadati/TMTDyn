...
MAKEFILE = sprdmpF122_mex.mk

include sprdmpF122_mex.mki


SRC_FILES =  \
	sprdmpF122_data.c \
	sprdmpF122_initialize.c \
	sprdmpF122_terminate.c \
	sprdmpF122.c \
	error.c \
	sqrt.c \
	_coder_sprdmpF122_info.c \
	_coder_sprdmpF122_api.c \
	_coder_sprdmpF122_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF122_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF122"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF122/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF122/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF122/%.cu
	$(CC) $(CCFLAGS) "$<"
