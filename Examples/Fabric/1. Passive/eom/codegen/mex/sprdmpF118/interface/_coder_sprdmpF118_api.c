 ...
 *
 * Code generation for function '_coder_sprdmpF118_api'
 *
 */
...
void sprdmpF118_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray
                    *plhs[8])
{
  real_T (*out1)[636];
  real_T (*out2)[6];
  ...
  sprdmpF118(&st, *in1, *in2, s, *out1, *out2, *out3, *out4, &out5, *out6, *out7,
             &out8);
...
/* End of code generation (_coder_sprdmpF118_api.c) */
