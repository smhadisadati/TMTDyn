...
MAKEFILE = sprdmpF118_mex.mk

include sprdmpF118_mex.mki


SRC_FILES =  \
	sprdmpF118_data.c \
	sprdmpF118_initialize.c \
	sprdmpF118_terminate.c \
	sprdmpF118.c \
	error.c \
	sqrt.c \
	_coder_sprdmpF118_info.c \
	_coder_sprdmpF118_api.c \
	_coder_sprdmpF118_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF118_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF118"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF118/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF118/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF118/%.cu
	$(CC) $(CCFLAGS) "$<"
