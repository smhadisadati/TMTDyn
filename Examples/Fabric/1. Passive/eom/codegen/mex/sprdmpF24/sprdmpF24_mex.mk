...
MAKEFILE = sprdmpF24_mex.mk

include sprdmpF24_mex.mki


SRC_FILES =  \
	sprdmpF24_data.c \
	sprdmpF24_initialize.c \
	sprdmpF24_terminate.c \
	sprdmpF24.c \
	_coder_sprdmpF24_info.c \
	_coder_sprdmpF24_api.c \
	_coder_sprdmpF24_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF24_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF24"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF24/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF24/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF24/%.cu
	$(CC) $(CCFLAGS) "$<"
