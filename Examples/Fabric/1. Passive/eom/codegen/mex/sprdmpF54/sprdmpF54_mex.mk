...
MAKEFILE = sprdmpF54_mex.mk

include sprdmpF54_mex.mki


SRC_FILES =  \
	sprdmpF54_data.c \
	sprdmpF54_initialize.c \
	sprdmpF54_terminate.c \
	sprdmpF54.c \
	_coder_sprdmpF54_info.c \
	_coder_sprdmpF54_api.c \
	_coder_sprdmpF54_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF54_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF54"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF54/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF54/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF54/%.cu
	$(CC) $(CCFLAGS) "$<"
