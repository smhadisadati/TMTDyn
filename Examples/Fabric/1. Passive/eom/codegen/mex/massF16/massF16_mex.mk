...
MAKEFILE = massF16_mex.mk

include massF16_mex.mki


SRC_FILES =  \
	massF16_data.c \
	massF16_initialize.c \
	massF16_terminate.c \
	massF16.c \
	error.c \
	sqrt.c \
	_coder_massF16_info.c \
	_coder_massF16_api.c \
	_coder_massF16_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = massF16_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/massF16"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/massF16/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/massF16/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/massF16/%.cu
	$(CC) $(CCFLAGS) "$<"
