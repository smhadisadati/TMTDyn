...
MAKEFILE = sprdmpF50_mex.mk

include sprdmpF50_mex.mki


SRC_FILES =  \
	sprdmpF50_data.c \
	sprdmpF50_initialize.c \
	sprdmpF50_terminate.c \
	sprdmpF50.c \
	_coder_sprdmpF50_info.c \
	_coder_sprdmpF50_api.c \
	_coder_sprdmpF50_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF50_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF50"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF50/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF50/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF50/%.cu
	$(CC) $(CCFLAGS) "$<"
