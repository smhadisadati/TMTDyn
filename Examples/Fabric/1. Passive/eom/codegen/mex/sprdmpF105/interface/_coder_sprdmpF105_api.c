 ...
 *
 * Code generation for function '_coder_sprdmpF105_api'
 *
 */
...
#include "_coder_sprdmpF105_api.h"
#include "sprdmpF105_data.h"
...
static real_T (*emlrt_marshallIn(const emlrtStack *sp, const mxArray *in1, const
  char_T *identifier))[6];
static const mxArray *emlrt_marshallOut(const real_T u[106]);
  ...
  static const mxArray *c_emlrt_marshallOut(const real_T u[106])
{
  ...
  static const int32_T iv5[2] = { 1, 106 };
  ...
  static const mxArray *emlrt_marshallOut(const real_T u[106])
{
  ...
  static const int32_T iv3[1] = { 106 };
...
void sprdmpF105_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray
                    *plhs[8])
{
  real_T (*out1)[106];
  real_T (*out6)[106];
  ...
  out1 = (real_T (*)[106])mxMalloc(sizeof(real_T [106]));
  out6 = (real_T (*)[106])mxMalloc(sizeof(real_T [106]));
  out7 = (real_T (*)[106])mxMalloc(sizeof(real_T [106]));
  ...
  sprdmpF105(*in1, *in2, s, *out1, &out2, &out3, &out4, &out5, *out6, *out7,
             &out8);
...
/* End of code generation (_coder_sprdmpF105_api.c) */
