...
MAKEFILE = sprdmpF105_mex.mk

include sprdmpF105_mex.mki


SRC_FILES =  \
	sprdmpF105_data.c \
	sprdmpF105_initialize.c \
	sprdmpF105_terminate.c \
	sprdmpF105.c \
	_coder_sprdmpF105_info.c \
	_coder_sprdmpF105_api.c \
	_coder_sprdmpF105_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF105_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF105"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF105/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF105/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF105/%.cu
	$(CC) $(CCFLAGS) "$<"
