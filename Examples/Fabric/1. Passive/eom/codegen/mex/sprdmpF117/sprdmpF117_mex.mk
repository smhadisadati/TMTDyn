...
MAKEFILE = sprdmpF117_mex.mk

include sprdmpF117_mex.mki


SRC_FILES =  \
	sprdmpF117_data.c \
	sprdmpF117_initialize.c \
	sprdmpF117_terminate.c \
	sprdmpF117.c \
	error.c \
	sqrt.c \
	_coder_sprdmpF117_info.c \
	_coder_sprdmpF117_api.c \
	_coder_sprdmpF117_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF117_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF117"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF117/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF117/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF117/%.cu
	$(CC) $(CCFLAGS) "$<"
