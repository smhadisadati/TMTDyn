...
MAKEFILE = sprdmpF126_mex.mk

include sprdmpF126_mex.mki


SRC_FILES =  \
	sprdmpF126_data.c \
	sprdmpF126_initialize.c \
	sprdmpF126_terminate.c \
	sprdmpF126.c \
	error.c \
	sqrt.c \
	_coder_sprdmpF126_info.c \
	_coder_sprdmpF126_api.c \
	_coder_sprdmpF126_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF126_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF126"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF126/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF126/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF126/%.cu
	$(CC) $(CCFLAGS) "$<"
