...
MAKEFILE = sprdmpF113_mex.mk

include sprdmpF113_mex.mki


SRC_FILES =  \
	sprdmpF113_data.c \
	sprdmpF113_initialize.c \
	sprdmpF113_terminate.c \
	sprdmpF113.c \
	error.c \
	sqrt.c \
	_coder_sprdmpF113_info.c \
	_coder_sprdmpF113_api.c \
	_coder_sprdmpF113_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF113_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF113"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF113/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF113/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF113/%.cu
	$(CC) $(CCFLAGS) "$<"
