...
MAKEFILE = sprdmpF42_mex.mk

include sprdmpF42_mex.mki


SRC_FILES =  \
	sprdmpF42_data.c \
	sprdmpF42_initialize.c \
	sprdmpF42_terminate.c \
	sprdmpF42.c \
	_coder_sprdmpF42_info.c \
	_coder_sprdmpF42_api.c \
	_coder_sprdmpF42_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF42_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF42"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF42/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF42/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF42/%.cu
	$(CC) $(CCFLAGS) "$<"
