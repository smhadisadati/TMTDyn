...
MAKEFILE = sprdmpF129_mex.mk

include sprdmpF129_mex.mki


SRC_FILES =  \
	sprdmpF129_data.c \
	sprdmpF129_initialize.c \
	sprdmpF129_terminate.c \
	sprdmpF129.c \
	error.c \
	sqrt.c \
	_coder_sprdmpF129_info.c \
	_coder_sprdmpF129_api.c \
	_coder_sprdmpF129_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF129_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF129"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF129/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF129/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF129/%.cu
	$(CC) $(CCFLAGS) "$<"
