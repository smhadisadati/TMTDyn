...
MAKEFILE = sprdmpF16_mex.mk

include sprdmpF16_mex.mki


SRC_FILES =  \
	sprdmpF16_data.c \
	sprdmpF16_initialize.c \
	sprdmpF16_terminate.c \
	sprdmpF16.c \
	_coder_sprdmpF16_info.c \
	_coder_sprdmpF16_api.c \
	_coder_sprdmpF16_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF16_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF16"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF16/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF16/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF16/%.cu
	$(CC) $(CCFLAGS) "$<"
