...
MAKEFILE = sprdmpF46_mex.mk

include sprdmpF46_mex.mki


SRC_FILES =  \
	sprdmpF46_data.c \
	sprdmpF46_initialize.c \
	sprdmpF46_terminate.c \
	sprdmpF46.c \
	_coder_sprdmpF46_info.c \
	_coder_sprdmpF46_api.c \
	_coder_sprdmpF46_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF46_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF46"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF46/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF46/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF46/%.cu
	$(CC) $(CCFLAGS) "$<"
