...
MAKEFILE = sprdmpF56_mex.mk

include sprdmpF56_mex.mki


SRC_FILES =  \
	sprdmpF56_data.c \
	sprdmpF56_initialize.c \
	sprdmpF56_terminate.c \
	sprdmpF56.c \
	_coder_sprdmpF56_info.c \
	_coder_sprdmpF56_api.c \
	_coder_sprdmpF56_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF56_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF56"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF56/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF56/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF56/%.cu
	$(CC) $(CCFLAGS) "$<"
