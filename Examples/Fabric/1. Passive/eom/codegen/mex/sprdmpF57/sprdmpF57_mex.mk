...
MAKEFILE = sprdmpF57_mex.mk

include sprdmpF57_mex.mki


SRC_FILES =  \
	sprdmpF57_data.c \
	sprdmpF57_initialize.c \
	sprdmpF57_terminate.c \
	sprdmpF57.c \
	_coder_sprdmpF57_info.c \
	_coder_sprdmpF57_api.c \
	_coder_sprdmpF57_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF57_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF57"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF57/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF57/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF57/%.cu
	$(CC) $(CCFLAGS) "$<"
