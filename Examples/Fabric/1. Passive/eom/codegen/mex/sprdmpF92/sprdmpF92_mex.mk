...
MAKEFILE = sprdmpF92_mex.mk

include sprdmpF92_mex.mki


SRC_FILES =  \
	sprdmpF92_data.c \
	sprdmpF92_initialize.c \
	sprdmpF92_terminate.c \
	sprdmpF92.c \
	_coder_sprdmpF92_info.c \
	_coder_sprdmpF92_api.c \
	_coder_sprdmpF92_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF92_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF92"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF92/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF92/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF92/%.cu
	$(CC) $(CCFLAGS) "$<"
