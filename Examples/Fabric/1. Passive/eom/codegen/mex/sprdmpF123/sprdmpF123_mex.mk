...
MAKEFILE = sprdmpF123_mex.mk

include sprdmpF123_mex.mki


SRC_FILES =  \
	sprdmpF123_data.c \
	sprdmpF123_initialize.c \
	sprdmpF123_terminate.c \
	sprdmpF123.c \
	error.c \
	sqrt.c \
	_coder_sprdmpF123_info.c \
	_coder_sprdmpF123_api.c \
	_coder_sprdmpF123_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF123_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF123"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF123/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF123/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF123/%.cu
	$(CC) $(CCFLAGS) "$<"
