...
MAKEFILE = sprdmpF103_mex.mk

include sprdmpF103_mex.mki


SRC_FILES =  \
	sprdmpF103_data.c \
	sprdmpF103_initialize.c \
	sprdmpF103_terminate.c \
	sprdmpF103.c \
	_coder_sprdmpF103_info.c \
	_coder_sprdmpF103_api.c \
	_coder_sprdmpF103_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF103_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF103"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF103/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF103/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF103/%.cu
	$(CC) $(CCFLAGS) "$<"
