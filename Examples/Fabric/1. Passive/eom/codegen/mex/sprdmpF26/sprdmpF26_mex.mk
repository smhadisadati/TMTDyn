...
MAKEFILE = sprdmpF26_mex.mk

include sprdmpF26_mex.mki


SRC_FILES =  \
	sprdmpF26_data.c \
	sprdmpF26_initialize.c \
	sprdmpF26_terminate.c \
	sprdmpF26.c \
	_coder_sprdmpF26_info.c \
	_coder_sprdmpF26_api.c \
	_coder_sprdmpF26_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF26_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF26"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF26/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF26/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF26/%.cu
	$(CC) $(CCFLAGS) "$<"
