...
MAKEFILE = sprdmpF87_mex.mk

include sprdmpF87_mex.mki


SRC_FILES =  \
	sprdmpF87_data.c \
	sprdmpF87_initialize.c \
	sprdmpF87_terminate.c \
	sprdmpF87.c \
	_coder_sprdmpF87_info.c \
	_coder_sprdmpF87_api.c \
	_coder_sprdmpF87_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF87_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF87"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF87/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF87/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF87/%.cu
	$(CC) $(CCFLAGS) "$<"
