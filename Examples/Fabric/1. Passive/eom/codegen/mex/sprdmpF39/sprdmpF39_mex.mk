...
MAKEFILE = sprdmpF39_mex.mk

include sprdmpF39_mex.mki


SRC_FILES =  \
	sprdmpF39_data.c \
	sprdmpF39_initialize.c \
	sprdmpF39_terminate.c \
	sprdmpF39.c \
	_coder_sprdmpF39_info.c \
	_coder_sprdmpF39_api.c \
	_coder_sprdmpF39_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF39_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF39"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF39/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF39/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF39/%.cu
	$(CC) $(CCFLAGS) "$<"
