...
MAKEFILE = sprdmpF90_mex.mk

include sprdmpF90_mex.mki


SRC_FILES =  \
	sprdmpF90_data.c \
	sprdmpF90_initialize.c \
	sprdmpF90_terminate.c \
	sprdmpF90.c \
	_coder_sprdmpF90_info.c \
	_coder_sprdmpF90_api.c \
	_coder_sprdmpF90_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF90_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF90"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF90/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF90/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF90/%.cu
	$(CC) $(CCFLAGS) "$<"
