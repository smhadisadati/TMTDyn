...
MAKEFILE = cnstF2_mex.mk

include cnstF2_mex.mki
...
SRC_FILES =  \
	...
	cnstF2_terminate.c \
	cnstF2.c \
	_coder_cnstF2_info.c \
	_coder_cnstF2_api.c \
	_coder_cnstF2_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = cnstF2_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/cnstF2"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/cnstF2/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/cnstF2/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/cnstF2/%.cu
	$(CC) $(CCFLAGS) "$<"
