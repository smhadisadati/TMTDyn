...
MAKEFILE = sprdmpF95_mex.mk

include sprdmpF95_mex.mki


SRC_FILES =  \
	sprdmpF95_data.c \
	sprdmpF95_initialize.c \
	sprdmpF95_terminate.c \
	sprdmpF95.c \
	_coder_sprdmpF95_info.c \
	_coder_sprdmpF95_api.c \
	_coder_sprdmpF95_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF95_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF95"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF95/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF95/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF95/%.cu
	$(CC) $(CCFLAGS) "$<"
