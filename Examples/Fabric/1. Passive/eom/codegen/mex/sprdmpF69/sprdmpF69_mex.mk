...
MAKEFILE = sprdmpF69_mex.mk

include sprdmpF69_mex.mki


SRC_FILES =  \
	sprdmpF69_data.c \
	sprdmpF69_initialize.c \
	sprdmpF69_terminate.c \
	sprdmpF69.c \
	_coder_sprdmpF69_info.c \
	_coder_sprdmpF69_api.c \
	_coder_sprdmpF69_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF69_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF69"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF69/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF69/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF69/%.cu
	$(CC) $(CCFLAGS) "$<"
