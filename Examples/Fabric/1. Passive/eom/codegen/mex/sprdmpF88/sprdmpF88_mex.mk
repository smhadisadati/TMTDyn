...
MAKEFILE = sprdmpF88_mex.mk

include sprdmpF88_mex.mki


SRC_FILES =  \
	sprdmpF88_data.c \
	sprdmpF88_initialize.c \
	sprdmpF88_terminate.c \
	sprdmpF88.c \
	_coder_sprdmpF88_info.c \
	_coder_sprdmpF88_api.c \
	_coder_sprdmpF88_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF88_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF88"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF88/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF88/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF88/%.cu
	$(CC) $(CCFLAGS) "$<"
