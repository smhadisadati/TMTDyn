...
MAKEFILE = sprdmpF104_mex.mk

include sprdmpF104_mex.mki


SRC_FILES =  \
	sprdmpF104_data.c \
	sprdmpF104_initialize.c \
	sprdmpF104_terminate.c \
	sprdmpF104.c \
	_coder_sprdmpF104_info.c \
	_coder_sprdmpF104_api.c \
	_coder_sprdmpF104_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF104_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF104"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF104/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF104/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF104/%.cu
	$(CC) $(CCFLAGS) "$<"
