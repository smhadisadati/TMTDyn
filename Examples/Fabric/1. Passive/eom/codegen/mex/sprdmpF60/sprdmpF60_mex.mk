...
MAKEFILE = sprdmpF60_mex.mk

include sprdmpF60_mex.mki


SRC_FILES =  \
	sprdmpF60_data.c \
	sprdmpF60_initialize.c \
	sprdmpF60_terminate.c \
	sprdmpF60.c \
	_coder_sprdmpF60_info.c \
	_coder_sprdmpF60_api.c \
	_coder_sprdmpF60_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF60_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF60"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF60/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF60/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF60/%.cu
	$(CC) $(CCFLAGS) "$<"
