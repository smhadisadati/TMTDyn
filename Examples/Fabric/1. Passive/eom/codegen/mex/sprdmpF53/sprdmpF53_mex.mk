...
MAKEFILE = sprdmpF53_mex.mk

include sprdmpF53_mex.mki


SRC_FILES =  \
	sprdmpF53_data.c \
	sprdmpF53_initialize.c \
	sprdmpF53_terminate.c \
	sprdmpF53.c \
	_coder_sprdmpF53_info.c \
	_coder_sprdmpF53_api.c \
	_coder_sprdmpF53_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF53_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF53"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF53/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF53/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF53/%.cu
	$(CC) $(CCFLAGS) "$<"
