...
MAKEFILE = sprdmpF93_mex.mk

include sprdmpF93_mex.mki


SRC_FILES =  \
	sprdmpF93_data.c \
	sprdmpF93_initialize.c \
	sprdmpF93_terminate.c \
	sprdmpF93.c \
	_coder_sprdmpF93_info.c \
	_coder_sprdmpF93_api.c \
	_coder_sprdmpF93_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF93_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF93"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF93/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF93/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF93/%.cu
	$(CC) $(CCFLAGS) "$<"
