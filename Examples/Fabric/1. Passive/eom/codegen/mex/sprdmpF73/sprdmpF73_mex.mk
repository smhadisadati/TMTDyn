...
MAKEFILE = sprdmpF73_mex.mk

include sprdmpF73_mex.mki


SRC_FILES =  \
	sprdmpF73_data.c \
	sprdmpF73_initialize.c \
	sprdmpF73_terminate.c \
	sprdmpF73.c \
	_coder_sprdmpF73_info.c \
	_coder_sprdmpF73_api.c \
	_coder_sprdmpF73_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF73_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF73"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF73/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF73/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF73/%.cu
	$(CC) $(CCFLAGS) "$<"
