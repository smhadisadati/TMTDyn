 ...
 * _coder_cnstF5_api.c
 *
 * Code generation for function '_coder_cnstF5_api'
 *
 */
  ...
  const char_T *identifier))[224]
{
  ...
  const emlrtMsgIdentifier *parentId))[224]
{
  real_T (*y)[224];
  ...
  static const mxArray *emlrt_marshallOut(const real_T u[106])
{
  ...
  static const int32_T iv3[2] = { 1, 106 };
...
void cnstF5_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray *
                plhs[3])
{
  real_T (*out1)[106];
  real_T (*out2)[106];
  ...
  out2 = (real_T (*)[106])mxMalloc(sizeof(real_T [106]));
  ...
  cnstF5(*in1, *in2, s, *out1, *out2, &out3);
...
/* End of code generation (_coder_cnstF5_api.c) */
