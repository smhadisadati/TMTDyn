 ...
 * sprdmpF121.c
 *
 * Code generation for function 'sprdmpF121'
 *
 */
...
static emlrtRSInfo emlrtRSI = { 41,    /* lineNo */
  "sprdmpF121",                        /* fcnName */
  "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0 HLL/Fabric/eom/sprdmpF121.m"/* pathName */
};
...
void sprdmpF121(const emlrtStack *sp, const real_T in1[6], const real_T in2[224],
                ...
                real_T *out8)
{
  ...
  b_sqrt(&st, &t78);
  t59 = 1.0 / t78;
  t60 = t23_tmp - in2[67] * t59;
  t62 = c_t20_tmp - in2[68] * t59;
  t64 = t13 - t401;
  st.site = &l_emlrtRSI;
  b_st.site = &w_emlrtRSI;
  t65 = 1.0 / (t6 * t6);
  t67 = t20_tmp - in2[66] * t59;
  t70 = b_t20_tmp - in2[69] * t59;
  ...
  t130 = t59 - t54 * t129;
  t132 = t59 - t55 * t129;
  t134_tmp = in2[62] * in2[66];
  t134 = t134_tmp * in2[67] * t13 * t129 * 2.0;
  t33 = in2[60] * in2[66];
  t135 = t33 * in2[68] * t13 * t129 * 2.0;
  t136 = t59 - t56 * t129;
  t138 = t59 - t57 * t129;
  t77 = in2[61] * in2[66];
  t139 = t77 * in2[69] * t13 * t129 * 2.0;
  t141_tmp = in2[61] * in2[67];
  t141 = t141_tmp * in2[69] * t13 * t129 * 2.0;
  t6 = in1[4] / 2.0;
  t143 = muDoubleScalarCos(t6);
  t144 = muDoubleScalarSin(t6);
  t147 = t143 * 0.077 - t144 / 25.0;
  t150 = t143 / 25.0 + t144 * 0.077;
  st.site = &n_emlrtRSI;
  b_st.site = &w_emlrtRSI;
  t151 = t143 * t143;
  st.site = &o_emlrtRSI;
  ...
  t195 = muDoubleScalarPower(muDoubleScalarAbs(((((((((t179 * in2[171] + t181 *
    ...
    in2[176]) + t178 * in2[175]) - t176 * in2[169]) - t177 * in2[177]) - t178 *
    in2[168]), in1[1] - 1.0);
  t204 = b_t20_tmp * t32;
  t205 = c_t20_tmp * t36;
  t206 = t401 * t23;
  ...
  t239 = muDoubleScalarPower(muDoubleScalarAbs(((((((((t226 * in2[171] + t228 *
    ...
    in2[177]) + t225 * in2[176]) - t223 * in2[170]) - t224 * in2[175]) - t225 *
    in2[169]), in1[1] - 1.0);
  t250 = t23_tmp * t26;
  t251 = b_t20_tmp * t36;
  t252 = t401 * t40;
  ...
  t283 = muDoubleScalarPower(muDoubleScalarAbs(((((((((t270 * in2[171] + t259 *
    ...
    in2[175]) + t269 * in2[177]) - t267 * in2[168]) - t268 * in2[176]) - t269 *
    in2[170]), in1[1] - 1.0);
  ...
  t308_tmp = t134_tmp * in2[68] * t13 * t129 * 2.0;
  t309 = t20_tmp * t132 * 2.0;
  t310 = t33 * in2[67] * t13 * t129 * 2.0;
  t50 = in2[62] * in2[67];
  t311 = t50 * in2[68] * t13 * t129 * 2.0;
  t6 = in2[59] * in2[67];
  t336_tmp = t6 * in2[68] * t13 * t129 * 2.0;
  t314 = ((t135 + b_t20_tmp * t136 * 2.0) + in2[61] * in2[68] * in2[69] * t13 *
          t129 * 2.0) - t336_tmp;
  t59 = t33 * in2[69] * t13 * t129 * 2.0;
  t57 = t404 * t67 * 2.0;
  ...
  t333_tmp = in2[59] * in2[66];
  t81 = t23_tmp * t130 * 2.0;
  t36 = t333_tmp * in2[67] * t13 * t129 * 2.0;
  t333 = ((-t139 + t308_tmp) + t81) + t36;
  t334 = ((t141 + t309) + t310) - t311;
  t339_tmp = t6 * in2[69] * t13 * t129 * 2.0;
  t27 = c_t20_tmp * t138 * 2.0;
  t74_tmp = in2[62] * in2[68] * in2[69] * t13 * t129 * 2.0;
  t341 = ((-t59 + t27) + t339_tmp) + t74_tmp;
  st.site = &s_emlrtRSI;
  b_st.site = &w_emlrtRSI;
  t344 = muDoubleScalarPower(muDoubleScalarAbs(((((((t316 * in2[171] + t307 *
    in2[174]) + t334 * in2[179]) + t314 * in2[180]) - t322 * in2[172]) - t327 *
    in2[173]) - t333 * in2[178]) - t341 * in2[181]), in1[1] - 1.0);
  t349 = t401 * t62 * 2.0;
  ...
  t16 = t405 * t70 * 2.0;
  t359_tmp = t77 * in2[67] * t13 * t129 * 2.0;
  t35 = t20_tmp * t136 * 2.0;
  t25 = t77 * in2[68] * t13 * t129 * 2.0;
  t24 = in2[60] * in2[68] * in2[69] * t13 * t129 * 2.0;
  t388_tmp = in2[59] * in2[68] * in2[69] * t13 * t129 * 2.0;
  t365 = ((t139 + t23_tmp * t138 * 2.0) + t50 * in2[69] * t13 * t129 * 2.0) -
    t388_tmp;
  t80 = t403 * t67 * 2.0;
  ...
  t132 = t6 * in2[68] * t13 * t129 * 2.0;
  t138 = ((-t141 + t24) + t20_tmp * t138 * 2.0) + t134_tmp * in2[69] * t13 *
    t129 * 2.0;
  ...
  out1[63] = t178;
  out1[64] = t176;
  out1[65] = -t124 + t127_tmp;
  memset(&out1[66], 0, 96U * sizeof(real_T));
  ...
  out1[168] = t222;
  out1[169] = -t8 + t125_tmp;
  out1[170] = t225;
  out1[171] = t223;
  memset(&out1[172], 0, 96U * sizeof(real_T));
  ...
  out1[275] = t267;
  out1[276] = -t11 + t128_tmp;
  out1[277] = t269;
  memset(&out1[278], 0, 99U * sizeof(real_T));
  ...
  out1[382] = 0.0;
  out1[383] = 0.0;
  out1[384] = ((t139 - t81) - t36) - t308_tmp;
  out1[385] = ((t141 + t309) + t310) - in2[62] * in2[67] * in2[68] * t13 * t129 *
    2.0;
  out1[386] = t314;
  out1[387] = ((t59 - t27) - t339_tmp) - t74_tmp;
  memset(&out1[388], 0, 95U * sizeof(real_T));
  ...
  out1[488] = 0.0;
  out1[489] = 0.0;
  out1[490] = ((t134 - t77) - t31) - t59;
  out1[491] = ((t359_tmp - t48) - t336_tmp) - t34;
  out1[492] = ((t311 + t35) + t25) - in2[60] * in2[68] * in2[69] * t13 * t129 *
    2.0;
  out1[493] = t365;
  memset(&out1[494], 0, 95U * sizeof(real_T));
  t82 = t35_tmp * t67 * 2.0;
  ...
  t50 = t333_tmp * in2[69] * t13 * t129 * 2.0;
  out1[596] = ((t135 - t33) - t50) - t359_tmp;
  out1[597] = ((t134 + t105) + t132) - t339_tmp;
  t77 = t23_tmp * t136 * 2.0;
  t6 = t141_tmp * in2[68] * t13 * t129 * 2.0;
  out1[598] = ((t308_tmp - t77) - t388_tmp) - t6;
  out1[599] = t138;
  ...
  t32 = muDoubleScalarPower(muDoubleScalarAbs(((((((t411 * in2[171] + t418 *
    in2[173]) + t355 * in2[179]) + t138 * in2[181]) - t417 * in2[172]) - t423 *
    in2[174]) - t426 * in2[178]) - t29 * in2[180]), in1[1] - 1.0);
  t50 = t143 * t147;
  t28 = t152 * 0.077;
  out2[0] = in1[0] * ((((((t143 * t144 * 0.154 - t144 * t147) - t143 * t150) +
    t20_tmp * t20) + b_t20_tmp * t23) - c_t20_tmp * t40) + t23_tmp * t44) *
    0.00026666666666666668;
  out2[1] = in1[0] * (((((t151 * 0.033825825826023878 + t152 *
    0.033825825826023878) - t20_tmp * t23) + b_t20_tmp * t20) - t23_tmp * t40) -
                      c_t20_tmp * t44) * -0.00026666666666666668;
  t6 = t144 * t150;
  out2[2] = in1[0] * (((((((t151 * -0.077 + t50) + t28) - t6) + c_t20_tmp * t20)
  ...
  out3[0] = ((((((((t52 * in2[173] + t80 * in2[169]) + t82 * in2[168]) - t30 *
                ...
                t195 * in2[171]) - t80 * in2[176]) - t82 * in2[175]) - in1[2] *
             t181 * t195 * in2[172]) + t30 * in2[177];
  t24 = in1[2] * t223 * t239;
  t25 = in1[2] * t225 * t239;
  t16 = -in1[2] * t224 * t239;
  t35 = in1[2] * t224 * t239;
  out3[1] = ((((((((t16 * in2[168] + t24 * in2[170]) + t25 * in2[169]) - in1[2] *
                ...
                t35 * in2[175]) - t24 * in2[177]) - in1[2] * t228 * t239 * in2
              [172]) - t25 * in2[176]) - in1[2] * t230 * t239 * in2[173];
  t27 = in1[2] * t267 * t283;
  t74_tmp = in1[2] * t268 * t283;
  t349 = in1[2] * t269 * t283;
  t350 = -in1[2] * t259 * t283;
  out3[2] = ((((((((t350 * in2[172] + t27 * in2[168]) - t74_tmp * in2[169]) +
                  t349 * in2[170]) - in1[2] * t270 * t283 * in2[171]) - t27 *
                in2[175]) + t74_tmp * in2[176]) - t349 * in2[177]) - in1[2] *
             t274 * t283 * in2[173]) - in1[2] * t276 * t283 * in2[174];
  t58 = in1[3] * t322 * t344;
  t54 = in1[3] * t327 * t344;
  t55 = -in1[3] * t307 * t344;
  t56 = in1[3] * t333 * t344;
  t59 = in1[3] * t341 * t344;
  out3[3] = ((((((t55 * in2[174] - in1[3] * t316 * t344 * in2[171]) - in1[3] *
                 t314 * t344 * in2[180]) + t58 * in2[172]) + t54 * in2[173]) +
              t56 * in2[178]) - in1[3] * t334 * t344 * in2[179]) + t59 * in2[181];
  t57 = -in1[3] * t366 * t392;
  t96 = in1[3] * t372 * t392;
  t83 = in1[3] * t379 * t392;
  t81 = in1[3] * t382 * t392;
  ...
  out3[4] = ((((((t57 * in2[171] + t96 * in2[173]) - in1[3] * t373 * t392 * in2
                 [172]) - in1[3] * t365 * t392 * in2[181]) + t83 * in2[174]) +
              t81 * in2[178]) + t36 * in2[179]) - in1[3] * t386 * t392 * in2[180];
  t75 = -in1[3] * t411 * t32;
  t79 = in1[3] * t417 * t32;
  t26 = in1[3] * t423 * t32;
  t99 = in1[3] * t426 * t32;
  t93 = in1[3] * t29 * t32;
  out3[5] = ((((((t75 * in2[171] + t79 * in2[172]) - in1[3] * t138 * t32 * in2
                 [181]) - in1[3] * t418 * t32 * in2[173]) + t26 * in2[174]) +
              t99 * in2[178]) - in1[3] * t355 * t32 * in2[179]) + t93 * in2[180];
  for (i = 0; i < 6; i++) {
    out4[i] = 0.0;
  }
  ...
  st.site = &v_emlrtRSI;
  b_sqrt(&st, &t78);
  *out5 = (((t151 * 0.077 - t50) - t28) + t78) + t6;
  ...
  out6[397] = 0.0;
  out6[398] = 0.0;
  out6[399] = in1[0] * t333 * -4.2666666666666668E-11;
  out6[400] = in1[0] * t382 * -1.421066666666666E-8;
  out6[401] = in1[0] * t426 * -4.75111111111111E-9;
  out6[402] = 0.0;
  out6[403] = 0.0;
  out6[404] = 0.0;
  out6[405] = in1[0] * t334 * 4.2666666666666668E-11;
  out6[406] = in1[0] * t385 * -1.421066666666666E-8;
  out6[407] = in1[0] * t355 * 4.75111111111111E-9;
  out6[408] = 0.0;
  out6[409] = 0.0;
  out6[410] = 0.0;
  out6[411] = in1[0] * t314 * 4.2666666666666668E-11;
  out6[412] = in1[0] * t386 * 1.421066666666666E-8;
  out6[413] = in1[0] * t29 * -4.75111111111111E-9;
  out6[414] = 0.0;
  out6[415] = 0.0;
  out6[416] = 0.0;
  out6[417] = in1[0] * t341 * -4.2666666666666668E-11;
  out6[418] = in1[0] * t365 * 1.421066666666666E-8;
  out6[419] = in1[0] * t138 * 4.75111111111111E-9;
  ...
  out7[403] = 0.0;
  out7[404] = 0.0;
  out7[405] = -in1[3] * t334 * t344;
  out7[406] = t36;
  out7[407] = -in1[3] * t355 * t32;
  out7[408] = 0.0;
  out7[409] = 0.0;
  out7[410] = 0.0;
  out7[411] = -in1[3] * t314 * t344;
  out7[412] = -in1[3] * t386 * t392;
  out7[413] = t93;
  out7[414] = 0.0;
  out7[415] = 0.0;
  out7[416] = 0.0;
  out7[417] = t59;
  out7[418] = -in1[3] * t365 * t392;
  out7[419] = -in1[3] * t138 * t32;
  memset(&out7[420], 0, 216U * sizeof(real_T));
  *out8 = 1.0;
}

/* End of code generation (sprdmpF121.c) */
