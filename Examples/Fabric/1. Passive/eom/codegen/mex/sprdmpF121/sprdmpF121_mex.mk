...
MAKEFILE = sprdmpF121_mex.mk

include sprdmpF121_mex.mki


SRC_FILES =  \
	sprdmpF121_data.c \
	sprdmpF121_initialize.c \
	sprdmpF121_terminate.c \
	sprdmpF121.c \
	error.c \
	sqrt.c \
	_coder_sprdmpF121_info.c \
	_coder_sprdmpF121_api.c \
	_coder_sprdmpF121_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF121_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF121"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF121/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF121/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF121/%.cu
	$(CC) $(CCFLAGS) "$<"
