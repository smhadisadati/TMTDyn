...
MAKEFILE = massF12_mex.mk

include massF12_mex.mki


SRC_FILES =  \
	massF12_data.c \
	massF12_initialize.c \
	massF12_terminate.c \
	massF12.c \
	error.c \
	sqrt.c \
	_coder_massF12_info.c \
	_coder_massF12_api.c \
	_coder_massF12_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = massF12_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/massF12"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/massF12/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/massF12/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/massF12/%.cu
	$(CC) $(CCFLAGS) "$<"
