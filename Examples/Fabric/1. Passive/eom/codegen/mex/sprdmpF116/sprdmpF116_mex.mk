...
MAKEFILE = sprdmpF116_mex.mk

include sprdmpF116_mex.mki


SRC_FILES =  \
	sprdmpF116_data.c \
	sprdmpF116_initialize.c \
	sprdmpF116_terminate.c \
	sprdmpF116.c \
	error.c \
	sqrt.c \
	_coder_sprdmpF116_info.c \
	_coder_sprdmpF116_api.c \
	_coder_sprdmpF116_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF116_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF116"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF116/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF116/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF116/%.cu
	$(CC) $(CCFLAGS) "$<"
