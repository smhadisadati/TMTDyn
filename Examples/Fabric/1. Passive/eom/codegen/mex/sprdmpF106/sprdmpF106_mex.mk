...
MAKEFILE = sprdmpF106_mex.mk

include sprdmpF106_mex.mki


SRC_FILES =  \
	sprdmpF106_data.c \
	sprdmpF106_initialize.c \
	sprdmpF106_terminate.c \
	sprdmpF106.c \
	_coder_sprdmpF106_info.c \
	_coder_sprdmpF106_api.c \
	_coder_sprdmpF106_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF106_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF106"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF106/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF106/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF106/%.cu
	$(CC) $(CCFLAGS) "$<"
