...
MAKEFILE = sprdmpF84_mex.mk

include sprdmpF84_mex.mki


SRC_FILES =  \
	sprdmpF84_data.c \
	sprdmpF84_initialize.c \
	sprdmpF84_terminate.c \
	sprdmpF84.c \
	_coder_sprdmpF84_info.c \
	_coder_sprdmpF84_api.c \
	_coder_sprdmpF84_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF84_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF84"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF84/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF84/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF84/%.cu
	$(CC) $(CCFLAGS) "$<"
