...
MAKEFILE = sprdmpF124_mex.mk

include sprdmpF124_mex.mki


SRC_FILES =  \
	sprdmpF124_data.c \
	sprdmpF124_initialize.c \
	sprdmpF124_terminate.c \
	sprdmpF124.c \
	error.c \
	sqrt.c \
	_coder_sprdmpF124_info.c \
	_coder_sprdmpF124_api.c \
	_coder_sprdmpF124_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF124_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF124"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF124/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF124/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF124/%.cu
	$(CC) $(CCFLAGS) "$<"
