...
MAKEFILE = sprdmpF21_mex.mk

include sprdmpF21_mex.mki


SRC_FILES =  \
	sprdmpF21_data.c \
	sprdmpF21_initialize.c \
	sprdmpF21_terminate.c \
	sprdmpF21.c \
	_coder_sprdmpF21_info.c \
	_coder_sprdmpF21_api.c \
	_coder_sprdmpF21_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF21_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF21"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF21/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF21/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF21/%.cu
	$(CC) $(CCFLAGS) "$<"
