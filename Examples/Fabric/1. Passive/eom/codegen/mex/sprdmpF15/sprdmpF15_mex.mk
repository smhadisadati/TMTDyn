...
MAKEFILE = sprdmpF15_mex.mk

include sprdmpF15_mex.mki


SRC_FILES =  \
	sprdmpF15_data.c \
	sprdmpF15_initialize.c \
	sprdmpF15_terminate.c \
	sprdmpF15.c \
	_coder_sprdmpF15_info.c \
	_coder_sprdmpF15_api.c \
	_coder_sprdmpF15_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF15_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF15"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF15/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF15/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF15/%.cu
	$(CC) $(CCFLAGS) "$<"
