...
MAKEFILE = massF13_mex.mk

include massF13_mex.mki


SRC_FILES =  \
	massF13_data.c \
	massF13_initialize.c \
	massF13_terminate.c \
	massF13.c \
	error.c \
	sqrt.c \
	_coder_massF13_info.c \
	_coder_massF13_api.c \
	_coder_massF13_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = massF13_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/massF13"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/massF13/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/massF13/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/massF13/%.cu
	$(CC) $(CCFLAGS) "$<"
