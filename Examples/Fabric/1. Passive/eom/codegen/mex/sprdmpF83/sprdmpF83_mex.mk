...
MAKEFILE = sprdmpF83_mex.mk

include sprdmpF83_mex.mki
...
SRC_FILES =  \
	...
	sprdmpF83.c \
	_coder_sprdmpF83_info.c \
	_coder_sprdmpF83_api.c \
	_coder_sprdmpF83_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF83_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF83"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF83/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF83/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF83/%.cu
	$(CC) $(CCFLAGS) "$<"
