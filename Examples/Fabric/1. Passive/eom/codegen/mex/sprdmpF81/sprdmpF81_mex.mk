...
MAKEFILE = sprdmpF81_mex.mk

include sprdmpF81_mex.mki


SRC_FILES =  \
	sprdmpF81_data.c \
	sprdmpF81_initialize.c \
	sprdmpF81_terminate.c \
	sprdmpF81.c \
	_coder_sprdmpF81_info.c \
	_coder_sprdmpF81_api.c \
	_coder_sprdmpF81_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF81_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF81"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF81/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF81/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF81/%.cu
	$(CC) $(CCFLAGS) "$<"
