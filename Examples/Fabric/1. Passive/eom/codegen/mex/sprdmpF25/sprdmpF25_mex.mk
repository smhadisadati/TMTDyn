...
MAKEFILE = sprdmpF25_mex.mk

include sprdmpF25_mex.mki


SRC_FILES =  \
	sprdmpF25_data.c \
	sprdmpF25_initialize.c \
	sprdmpF25_terminate.c \
	sprdmpF25.c \
	_coder_sprdmpF25_info.c \
	_coder_sprdmpF25_api.c \
	_coder_sprdmpF25_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF25_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF25"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF25/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF25/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF25/%.cu
	$(CC) $(CCFLAGS) "$<"
