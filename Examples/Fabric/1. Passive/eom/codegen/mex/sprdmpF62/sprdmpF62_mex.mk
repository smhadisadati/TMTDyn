...
MAKEFILE = sprdmpF62_mex.mk

include sprdmpF62_mex.mki


SRC_FILES =  \
	sprdmpF62_data.c \
	sprdmpF62_initialize.c \
	sprdmpF62_terminate.c \
	sprdmpF62.c \
	_coder_sprdmpF62_info.c \
	_coder_sprdmpF62_api.c \
	_coder_sprdmpF62_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF62_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF62"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF62/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF62/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF62/%.cu
	$(CC) $(CCFLAGS) "$<"
