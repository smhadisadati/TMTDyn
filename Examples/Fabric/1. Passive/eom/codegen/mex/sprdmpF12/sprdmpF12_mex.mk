...
MAKEFILE = sprdmpF12_mex.mk

include sprdmpF12_mex.mki


SRC_FILES =  \
	sprdmpF12_data.c \
	sprdmpF12_initialize.c \
	sprdmpF12_terminate.c \
	sprdmpF12.c \
	_coder_sprdmpF12_info.c \
	_coder_sprdmpF12_api.c \
	_coder_sprdmpF12_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF12_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF12"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF12/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF12/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF12/%.cu
	$(CC) $(CCFLAGS) "$<"
