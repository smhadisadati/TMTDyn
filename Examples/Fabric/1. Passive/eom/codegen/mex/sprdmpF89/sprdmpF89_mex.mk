...
MAKEFILE = sprdmpF89_mex.mk

include sprdmpF89_mex.mki


SRC_FILES =  \
	sprdmpF89_data.c \
	sprdmpF89_initialize.c \
	sprdmpF89_terminate.c \
	sprdmpF89.c \
	_coder_sprdmpF89_info.c \
	_coder_sprdmpF89_api.c \
	_coder_sprdmpF89_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF89_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF89"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF89/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF89/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF89/%.cu
	$(CC) $(CCFLAGS) "$<"
