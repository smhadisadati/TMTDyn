...
MAKEFILE = massF10_mex.mk

include massF10_mex.mki


SRC_FILES =  \
	massF10_data.c \
	massF10_initialize.c \
	massF10_terminate.c \
	massF10.c \
	error.c \
	sqrt.c \
	_coder_massF10_info.c \
	_coder_massF10_api.c \
	_coder_massF10_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = massF10_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/massF10"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/massF10/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/massF10/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/massF10/%.cu
	$(CC) $(CCFLAGS) "$<"
