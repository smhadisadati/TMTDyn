 ...
 * _coder_massF3_api.c
 *
 * Code generation for function '_coder_massF3_api'
 *
 */
...
void massF3_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray *
                plhs[4])
{
  real_T (*out1)[36];
  real_T (*out2)[636];
  ...
  massF3(&st, *in1, *in2, s, *out1, *out2, *out3, *out4);
...
/* End of code generation (_coder_massF3_api.c) */
