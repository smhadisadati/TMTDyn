...
MAKEFILE = sprdmpF115_mex.mk

include sprdmpF115_mex.mki


SRC_FILES =  \
	sprdmpF115_data.c \
	sprdmpF115_initialize.c \
	sprdmpF115_terminate.c \
	sprdmpF115.c \
	error.c \
	sqrt.c \
	_coder_sprdmpF115_info.c \
	_coder_sprdmpF115_api.c \
	_coder_sprdmpF115_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF115_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF115"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF115/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF115/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF115/%.cu
	$(CC) $(CCFLAGS) "$<"
