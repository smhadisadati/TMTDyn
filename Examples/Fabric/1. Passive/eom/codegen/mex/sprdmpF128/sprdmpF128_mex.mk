...
MAKEFILE = sprdmpF128_mex.mk

include sprdmpF128_mex.mki


SRC_FILES =  \
	sprdmpF128_data.c \
	sprdmpF128_initialize.c \
	sprdmpF128_terminate.c \
	sprdmpF128.c \
	error.c \
	sqrt.c \
	_coder_sprdmpF128_info.c \
	_coder_sprdmpF128_api.c \
	_coder_sprdmpF128_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF128_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF128"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF128/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF128/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF128/%.cu
	$(CC) $(CCFLAGS) "$<"
