...
MAKEFILE = sprdmpF80_mex.mk

include sprdmpF80_mex.mki


SRC_FILES =  \
	sprdmpF80_data.c \
	sprdmpF80_initialize.c \
	sprdmpF80_terminate.c \
	sprdmpF80.c \
	_coder_sprdmpF80_info.c \
	_coder_sprdmpF80_api.c \
	_coder_sprdmpF80_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF80_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF80"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF80/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF80/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF80/%.cu
	$(CC) $(CCFLAGS) "$<"
