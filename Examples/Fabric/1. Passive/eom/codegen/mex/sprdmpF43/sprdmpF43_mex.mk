...
MAKEFILE = sprdmpF43_mex.mk

include sprdmpF43_mex.mki


SRC_FILES =  \
	sprdmpF43_data.c \
	sprdmpF43_initialize.c \
	sprdmpF43_terminate.c \
	sprdmpF43.c \
	_coder_sprdmpF43_info.c \
	_coder_sprdmpF43_api.c \
	_coder_sprdmpF43_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF43_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF43"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF43/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF43/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF43/%.cu
	$(CC) $(CCFLAGS) "$<"
