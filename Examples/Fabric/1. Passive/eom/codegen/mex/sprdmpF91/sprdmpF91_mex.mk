...
MAKEFILE = sprdmpF91_mex.mk

include sprdmpF91_mex.mki


SRC_FILES =  \
	sprdmpF91_data.c \
	sprdmpF91_initialize.c \
	sprdmpF91_terminate.c \
	sprdmpF91.c \
	_coder_sprdmpF91_info.c \
	_coder_sprdmpF91_api.c \
	_coder_sprdmpF91_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF91_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF91"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF91/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF91/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF91/%.cu
	$(CC) $(CCFLAGS) "$<"
