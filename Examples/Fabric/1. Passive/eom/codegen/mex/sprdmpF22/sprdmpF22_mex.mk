...
MAKEFILE = sprdmpF22_mex.mk

include sprdmpF22_mex.mki


SRC_FILES =  \
	sprdmpF22_data.c \
	sprdmpF22_initialize.c \
	sprdmpF22_terminate.c \
	sprdmpF22.c \
	_coder_sprdmpF22_info.c \
	_coder_sprdmpF22_api.c \
	_coder_sprdmpF22_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF22_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF22"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF22/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF22/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF22/%.cu
	$(CC) $(CCFLAGS) "$<"
