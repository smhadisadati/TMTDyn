...
MAKEFILE = sprdmpF29_mex.mk

include sprdmpF29_mex.mki


SRC_FILES =  \
	sprdmpF29_data.c \
	sprdmpF29_initialize.c \
	sprdmpF29_terminate.c \
	sprdmpF29.c \
	_coder_sprdmpF29_info.c \
	_coder_sprdmpF29_api.c \
	_coder_sprdmpF29_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF29_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF29"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF29/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF29/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF29/%.cu
	$(CC) $(CCFLAGS) "$<"
