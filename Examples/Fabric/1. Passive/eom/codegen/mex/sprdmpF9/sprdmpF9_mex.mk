...
MAKEFILE = sprdmpF9_mex.mk

include sprdmpF9_mex.mki


SRC_FILES =  \
	sprdmpF9_data.c \
	sprdmpF9_initialize.c \
	sprdmpF9_terminate.c \
	sprdmpF9.c \
	_coder_sprdmpF9_info.c \
	_coder_sprdmpF9_api.c \
	_coder_sprdmpF9_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF9_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF9"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF9/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF9/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v2.0\ HLL/Fabric/eom/codegen/mex/sprdmpF9/%.cu
	$(CC) $(CCFLAGS) "$<"
