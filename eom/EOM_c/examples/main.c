...
static void argInit_37x4_real_T(double result[148]);
static void argInit_37x7_real_T(double result[259]);
...
static void argInit_37x4_real_T(double result[148])
{
  ...
  for (idx0 = 0; idx0 < 37; idx0++) {
    ...
    /* Set the value of the array element.
       Change this value to the value that the application requires. */
    result[idx0 + 37] = result_tmp;

    /* Set the value of the array element.
       Change this value to the value that the application requires. */
    result[idx0 + 74] = argInit_real_T();

    /* Set the value of the array element.
       Change this value to the value that the application requires. */
    result[idx0 + 111] = argInit_real_T();
  }
}

/*
 * Arguments    : double result[259]
 * Return Type  : void
 */
static void argInit_37x7_real_T(double result[259])
{
  ...
  for (idx0 = 0; idx0 < 37; idx0++) {
    for (idx1 = 0; idx1 < 7; idx1++) {
      /* Set the value of the array element.
         Change this value to the value that the application requires. */
      result[idx0 + 37 * idx1] = argInit_real_T();
    }
  }
}
...
static void argInit_struct2_T(struct2_T *result)
{
  /* Set the value of each structure field.
     Change this value to the value that the application requires. */
  argInit_37x7_real_T(result->pos);
}
...
static void argInit_struct3_T(struct3_T *result)
{
  /* Set the value of each structure field.
     Change this value to the value that the application requires. */
  argInit_37x4_real_T(result->tube2);
}
