...
static void argInit_1707x4_real_T(double result[6828]);
static void argInit_1707x6_real_T(double result[10242]);
static void argInit_1710x5_real_T(double result[8550]);
...
static void argInit_1707x4_real_T(double result[6828])
{
  ...
  for (idx0 = 0; idx0 < 1707; idx0++) {
    for (idx1 = 0; idx1 < 4; idx1++) {
      /* Set the value of the array element.
         Change this value to the value that the application requires. */
      result[idx0 + 1707 * idx1] = argInit_real_T();
    }
  }
}

/*
 * Arguments    : double result[10242]
 * Return Type  : void
 */
static void argInit_1707x6_real_T(double result[10242])
{
...
static void argInit_1710x5_real_T(double result[8550])
{
  ...
  /* Loop over the array to initialize each element. */
  for (idx0 = 0; idx0 < 1710; idx0++) {
    for (idx1 = 0; idx1 < 5; idx1++) {
      /* Set the value of the array element.
         Change this value to the value that the application requires. */
      result[idx0 + 1710 * idx1] = argInit_real_T();
    }
  }
}
...
static void argInit_struct1_T(struct1_T *result)
{
  ...
  argInit_1710x5_real_T(result->tip_load);
}
...
static void argInit_struct2_T(struct2_T *result)
{
  ...
  /* Set the value of each structure field.
     Change this value to the value that the application requires. */
  argInit_1707x6_real_T(result->pos);
  for (i = 0; i < 10242; i++) {
    d = result->pos[i];
    result->vel[i] = d;
    result->acc[i] = d;
...
static void argInit_struct3_T(struct3_T *result)
{
  ...
  /* Set the value of each structure field.
     Change this value to the value that the application requires. */
  argInit_1707x4_real_T(result->tube1);
  for (i = 0; i < 6828; i++) {
    d = result->tube1[i];
