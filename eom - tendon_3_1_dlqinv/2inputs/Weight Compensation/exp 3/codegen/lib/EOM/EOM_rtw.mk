...
## 
## Makefile     : EOM_rtw.mk
## Generated on : Sat May 08 01:58:00 2021
...
START_DIR                 = C:\Users\customer\MEGAsync\Hadi\Friends\Research\TENDON~1\Model\IZADTM~1\eom\codegen\lib\EOM
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
SRCS = $(START_DIR)\EOM_data.c $(START_DIR)\EOM_initialize.c $(START_DIR)\EOM_terminate.c $(START_DIR)\EOM.c $(START_DIR)\interp1.c $(START_DIR)\spline.c $(START_DIR)\massT1.c $(START_DIR)\sprdmpTt19.c $(START_DIR)\sprdmpKx19.c $(START_DIR)\sprdmpVd19.c $(START_DIR)\sprdmpTtu19.c $(START_DIR)\loadsTt1.c $(START_DIR)\pinv.c $(START_DIR)\svd.c $(START_DIR)\xnrm2.c $(START_DIR)\xdotc.c $(START_DIR)\EOM_input.c $(START_DIR)\dyn_mid_step.c $(START_DIR)\xaxpy.c $(START_DIR)\xrotg.c $(START_DIR)\xrot.c $(START_DIR)\xswap.c
...
OBJS = EOM_data.obj EOM_initialize.obj EOM_terminate.obj EOM.obj interp1.obj spline.obj massT1.obj sprdmpTt19.obj sprdmpKx19.obj sprdmpVd19.obj sprdmpTtu19.obj loadsTt1.obj pinv.obj svd.obj xnrm2.obj xdotc.obj EOM_input.obj dyn_mid_step.obj xaxpy.obj xrotg.obj xrot.obj xswap.obj
...
{C:\Users\customer\MEGAsync\Hadi\Friends\Research\TENDON~1\Model\IZADTM~1\eom}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{C:\Users\customer\MEGAsync\Hadi\Friends\Research\TENDON~1\Model\IZADTM~1\eom}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
interp1.obj : $(START_DIR)\interp1.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\interp1.c


spline.obj : $(START_DIR)\spline.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\spline.c


massT1.obj : $(START_DIR)\massT1.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\massT1.c


sprdmpTt19.obj : $(START_DIR)\sprdmpTt19.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sprdmpTt19.c


sprdmpKx19.obj : $(START_DIR)\sprdmpKx19.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sprdmpKx19.c


sprdmpVd19.obj : $(START_DIR)\sprdmpVd19.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sprdmpVd19.c


sprdmpTtu19.obj : $(START_DIR)\sprdmpTtu19.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sprdmpTtu19.c


loadsTt1.obj : $(START_DIR)\loadsTt1.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\loadsTt1.c
