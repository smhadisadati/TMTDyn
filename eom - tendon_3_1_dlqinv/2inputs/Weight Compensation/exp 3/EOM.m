...
sn = 1e-06 ; 
    ...
    Tt = sprdmpTt19( par_mex.var , z , sn * ( rom_sprdmp(19,2) - rom_sprdmp(19,1) ) + rom_sprdmp(19,1) , ( rom_sprdmp(19,2) - rom_sprdmp(19,1) ) / 10 , t ) ;
    kx = sprdmpKx19( par_mex.var , z , sn * ( rom_sprdmp(19,2) - rom_sprdmp(19,1) ) + rom_sprdmp(19,1) , ( rom_sprdmp(19,2) - rom_sprdmp(19,1) ) / 10 , t ) ;
    vd = sprdmpVd19( par_mex.var , z , sn * ( rom_sprdmp(19,2) - rom_sprdmp(19,1) ) + rom_sprdmp(19,1) , ( rom_sprdmp(19,2) - rom_sprdmp(19,1) ) / 10 , t ) ;
    in = sprdmpIn19( par_mex.var , z , sn * ( rom_sprdmp(19,2) - rom_sprdmp(19,1) ) + rom_sprdmp(19,1) , ( rom_sprdmp(19,2) - rom_sprdmp(19,1) ) / 10 , t ) ;
    ttu = sprdmpTtu19( par_mex.var , z , sn * ( rom_sprdmp(19,2) - rom_sprdmp(19,1) ) + rom_sprdmp(19,1) , ( rom_sprdmp(19,2) - rom_sprdmp(19,1) ) / 10 , t ) ;
    dir = sprdmpDir19( par_mex.var , z , sn * ( rom_sprdmp(19,2) - rom_sprdmp(19,1) ) + rom_sprdmp(19,1) , ( rom_sprdmp(19,2) - rom_sprdmp(19,1) ) / 10 , t ) ;
    w_vd_j = w_vd_j + dir * Tt * vd * ( rom_sprdmp(19,2) - rom_sprdmp(19,1) ) ;
    w_sd = w_sd + dir * Tt * kx * ( rom_sprdmp(19,2) - rom_sprdmp(19,1) ) ;
    w_in = w_in + dir * Tt * in * ( rom_sprdmp(19,2) - rom_sprdmp(19,1) ) ;
    Ttu_19 = Ttu_19 + ttu * ( rom_sprdmp(19,2) - rom_sprdmp(19,1) ) ;
...
Tt = sprdmpTt18( par_mex.var , z , 0 , 0 , t ) ;
kx = sprdmpKx18( par_mex.var , z , 0 , 0 , t ) ;
vd = sprdmpVd18( par_mex.var , z , 0 , 0 , t ) ;
in = sprdmpIn18( par_mex.var , z , 0 , 0 , t ) ;
dir = sprdmpDir18( par_mex.var , z , 0 , 0 , t ) ;
...
dY = u ;
ddY = pinv( TMT , 1e-24 ) * ( d_eom_q + w_vd_j + fj_vd + Tct * U - 1e-24 * TMT * u( 1 : 17 + 0 ) ) ;
