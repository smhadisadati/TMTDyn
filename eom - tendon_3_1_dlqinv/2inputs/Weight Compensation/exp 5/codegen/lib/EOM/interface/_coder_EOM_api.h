...
typedef struct {
  real_T tube1[58336];
  real_T tube1_vel[58336];
  real_T tube1_acc[58336];
} struct3_T;
...
extern "C" {
  ...
  void EOM(real_T t, real_T z[38], struct0_T *par_mex, real_T dz[38], real_T
           *flag);
  void EOM_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray *plhs
               [3]);
  void EOM_atexit(void);
  void EOM_initialize(void);
  void EOM_input(real_T tspan[3], real_T *nz, real_T z0[38], struct0_T *par_mex);
