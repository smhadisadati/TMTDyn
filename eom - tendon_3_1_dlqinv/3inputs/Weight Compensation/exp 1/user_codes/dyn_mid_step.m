...
% dl = q_u(5);
dl = z(18) ; % last state in q is equal to the introducer displacement

%% tip positions
q_d = interp1(par_mex.user_pars.tip_pos.tube1(:,1), par_mex.user_pars.tip_pos.tube1(:,2:end), t, 'linear', 0) ;
dq_d = interp1(par_mex.user_pars.tip_pos.tube1_vel(:,1), par_mex.user_pars.tip_pos.tube1_vel(:,2:end), t, 'linear', 0) ;
ddq_d = interp1(par_mex.user_pars.tip_pos.tube1_acc(:,1), par_mex.user_pars.tip_pos.tube1_acc(:,2:end), t, 'linear', 0) ;
