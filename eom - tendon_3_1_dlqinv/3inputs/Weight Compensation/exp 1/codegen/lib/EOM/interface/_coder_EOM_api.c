...
static const mxArray *f_emlrt_marshallOut(const real_T u[10242]);
static void g_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, struct1_T *y);
static const mxArray *g_emlrt_marshallOut(const real_T u[6828]);
...
static void l_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, real_T y[8550]);
...
static void r_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, real_T ret[8550]);
...
static const mxArray *e_emlrt_marshallOut(const struct0_T *u)
{
  static const int32_T iv[2] = { 1710, 5 };
...
/*
 * Arguments    : const real_T u[10242]
 * Return Type  : const mxArray *
 */
static const mxArray *f_emlrt_marshallOut(const real_T u[10242])
{
...
static void r_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, real_T ret[8550])
{
  static const int32_T dims[2] = { 1710, 5 };

  real_T (*r)[8550];
  int32_T i;
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r = (real_T (*)[8550])emlrtMxGetData(src);
  for (i = 0; i < 8550; i++) {
    ret[i] = (*r)[i];
  }
