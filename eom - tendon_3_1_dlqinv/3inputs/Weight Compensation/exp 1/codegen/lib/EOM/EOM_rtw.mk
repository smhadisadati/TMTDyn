...
## 
## Makefile     : EOM_rtw.mk
## Generated on : Sat May 08 03:30:09 2021
...
SRCS = $(START_DIR)\EOM_data.c $(START_DIR)\EOM_initialize.c $(START_DIR)\EOM_terminate.c $(START_DIR)\EOM.c $(START_DIR)\interp1.c $(START_DIR)\massT1.c $(START_DIR)\sprdmpTt20.c $(START_DIR)\sprdmpKx20.c $(START_DIR)\sprdmpVd20.c $(START_DIR)\sprdmpTtu20.c $(START_DIR)\loadsTt1.c $(START_DIR)\pinv.c $(START_DIR)\svd.c $(START_DIR)\xnrm2.c $(START_DIR)\xdotc.c $(START_DIR)\svd1.c $(START_DIR)\EOM_input.c $(START_DIR)\dyn_mid_step.c $(START_DIR)\xaxpy.c $(START_DIR)\xrotg.c $(START_DIR)\xrot.c $(START_DIR)\xswap.c
...
OBJS = EOM_data.obj EOM_initialize.obj EOM_terminate.obj EOM.obj interp1.obj massT1.obj sprdmpTt20.obj sprdmpKx20.obj sprdmpVd20.obj sprdmpTtu20.obj loadsTt1.obj pinv.obj svd.obj xnrm2.obj xdotc.obj svd1.obj EOM_input.obj dyn_mid_step.obj xaxpy.obj xrotg.obj xrot.obj xswap.obj
...
sprdmpTt20.obj : $(START_DIR)\sprdmpTt20.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sprdmpTt20.c


sprdmpKx20.obj : $(START_DIR)\sprdmpKx20.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sprdmpKx20.c


sprdmpVd20.obj : $(START_DIR)\sprdmpVd20.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sprdmpVd20.c


sprdmpTtu20.obj : $(START_DIR)\sprdmpTtu20.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sprdmpTtu20.c
