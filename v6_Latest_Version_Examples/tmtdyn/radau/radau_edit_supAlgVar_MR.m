...
function [tout, yout] = radau_edit_supAlgVar_MR(odefun,tspan,y0,vars,options)
%
...
while (Stat.StepNbr <= MaxNbrStep && PosNeg*t < PosNeg*tfinal) % ligne 849 fortran
    ...
    while NewtContinue
        ...
        % [~, Mass] = feval(odefun,t,y,vars); % t,y are not updated since last call
