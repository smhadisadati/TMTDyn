function tubeplot(curve,r,clr,n,isWireframe)
...
% Cite As: Janus H. Wesenberg (2021). TubePlot (https://www.mathworks.com/matlabcentral/fileexchange/5562-tubeplot), MATLAB Central File Exchange. Retrieved February 9, 2021.

% if nargin<5 || isempty(ct); ct=0.5*r; end
% if nargin<4 || isempty(n); n=10; end
% if nargin<3 || isempty(clr); clr='cyan'; end
% if nargin<2, error('Give at least curve and radius'); end
% if size(curve,1)~=3; error('Malformed curve: should be [3,N]'); end
