...
TMT = zeros(15,15) ; TMfd = zeros(15,1) ;
w_vd_j = zeros(15,1) ; w_sd = zeros(15,1) ; w_in = zeros(15,1) ;
w_f = zeros(15,1) ;
Tc = [] ; Tct = Tj_u ; dc = [] ;
...
sn = 1e-06 ; 
    ...
    [ Tt , kx , vd , in , ~ , dir ] = sprdmpF16( par_mex.var , z , sn * ( rom_sprdmp(16,2) - rom_sprdmp(16,1) ) + rom_sprdmp(16,1) , ( rom_sprdmp(16,2) - rom_sprdmp(16,1) ) / 10 , t ) ;
    w_vd_j = w_vd_j + dir * Tt * vd * ( rom_sprdmp(16,2) - rom_sprdmp(16,1) ) ;
    w_sd = w_sd + dir * Tt * kx * ( rom_sprdmp(16,2) - rom_sprdmp(16,1) ) ;
    w_in = w_in + dir * Tt * in * ( rom_sprdmp(16,2) - rom_sprdmp(16,1) ) ;
