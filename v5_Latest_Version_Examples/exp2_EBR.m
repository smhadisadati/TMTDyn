...
mu_uv = [ mu_x_ mu_y_ mu_z_ mu_xx_ mu_yy_ mu_zz_ ] ;
ftau_uv = [ f_p tau_p ] ;
...
results = results...
        ...
        .robot('series_rigid_link_arm')... % robot
            .body('rigid_link')...
                ...
                .with_cross_section_radius(lambda_*r_s2_)...
                        ...
                        .translation([inf,inf,inf])... % axial translation w.r.t. previous joint copy
                            ...
                            .dof(3)...
                                ...
                                .parallel_damper()...
                                    ...
                                    .power(mu_pow_) ;
results = results...
                        .rot_strain([inf, inf, inf], [1 0 0 0 ])...
                            .dof(1)...
                                .direct_input('force', ftau_uv(4))...
                                .parallel_spring()...
                                    .coefficient(K_uv(4))...
                                .parallel_damper()...
                                    .viscosity(mu_uv(4))...
                            .dof(2)...
                                .direct_input('force', ftau_uv(5))...
                                .parallel_spring()...
                                    .coefficient(K_uv(5))...
                                .parallel_damper()...
                                    .viscosity(mu_uv(5))...
