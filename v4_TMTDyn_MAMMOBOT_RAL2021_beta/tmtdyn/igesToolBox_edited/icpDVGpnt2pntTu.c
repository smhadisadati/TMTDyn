 ...
 * Usage:
 *
 * icpDVGpnt2pntTu(DATA,quality,quasirand,sizerand,randincreasing,maxiter,kTu,SURFDATA,DVGdata,R,t)
 *
 * Input:
 *
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray*prhs[]){
    ...
    icpDVGpnt2pntTu(mxGetPr(data), mxGetPr(quality), (unsigned int)mxGetN(data), (unsigned int*)mxGetPr(randvec), (unsigned int)mxGetScalar(sizerand), (unsigned int)mxGetScalar(randincrease), (unsigned int)mxGetScalar(maxiter), mxGetScalar(kTukey), mxGetPr(surfdata), DVGdata, mxGetPr(rotationMatrixIO), mxGetPr(transVecIO));
