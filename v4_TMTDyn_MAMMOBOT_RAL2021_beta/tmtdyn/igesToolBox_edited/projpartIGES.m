function [model,UV,srfind,srfDerivind,srfDer,numpoints]=projpartIGES(ParameterData,projEye,normal,pdir,sdir,dp,nppos,npneg,nspos,nsneg)
...
pO=[pdir sdir]\(projEye-pdir*(npneg*dp)-sdir*(nsneg*dp));
