...
%             [t, z] = radau_mexedit_mex(tspan, z0', par_mex, options) ;
    ...
    case 6 % wait for external solver
        try
            fprintf( 'importing external results from file ./eom/EOM_c/results.txt ... \n' )
            results_file = './eom/EOM_c/results.txt';
            delimiterIn = '\t';
