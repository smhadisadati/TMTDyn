...
static void i_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, real_T y[224]);
...
static void o_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, real_T ret[224]);
...
static const mxArray *e_emlrt_marshallOut(const struct0_T *u)
{
  ...
  const mxArray *d_y;
  const mxArray *m4;
  static const int32_T iv6[2] = { 32, 7 };
  ...
  static const int32_T iv7[2] = { 32, 4 };
  ...
  for (i = 0; i < 7; i++) {
    for (b_i = 0; b_i < 32; b_i++) {
      pData[i0] = u->user_pars.motor_in.pos[b_i + (i << 5)];
      i0++;
    }
  }
  ...
  for (i = 0; i < 4; i++) {
    for (b_i = 0; b_i < 32; b_i++) {
      pData[i0] = u->user_pars.tip_pos.tube2[b_i + (i << 5)];
      i0++;
    }
  }
 ...
 */
  ...
  emlrtMsgIdentifier *msgId, real_T ret[224])
{
  static const int32_T dims[2] = { 32, 7 };

  real_T (*r0)[224];
  int32_T i1;
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r0 = (real_T (*)[224])emlrtMxGetData(src);
  for (i1 = 0; i1 < 224; i1++) {
    ret[i1] = (*r0)[i1];
  }
...
static void p_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, real_T ret[128])
{
  static const int32_T dims[2] = { 32, 4 };

  real_T (*r1)[128];
  int32_T i2;
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r1 = (real_T (*)[128])emlrtMxGetData(src);
  for (i2 = 0; i2 < 128; i2++) {
    ret[i2] = (*r1)[i2];
  }
