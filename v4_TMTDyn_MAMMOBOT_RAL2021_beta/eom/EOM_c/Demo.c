...
////////////////////////////////////////////////////////////////////////////////////
/* to compile & run:
cd "/mnt/c/Users/customer/MEGAsync/Hadi/Postdoc/2_KCL/2_Research/1. Model/MOMOBOT TMTDyn/eom/EOM_c"
...
// g++ EOM/*.c Demo.c -O3 -mtune=native -DNDEBUG -o Demo -I"/mnt/c/Program Files/MATLAB/R2019a/extern/include" -I/mnt/c/sundials-5.0.0-dev.1/instdir/include -L/mnt/c/sundials-5.0.0-dev.1/instdir/lib -lsundials_cvode -lsundials_nvecserial -lsundials_nvecmanyvector -lm /usr/lib/x86_64-linux-gnu/librt.so -Wl,-rpath,/mnt/c/sundials-5.0.0-dev.1/instdir/lib
./Demo
///////////////////////////////////////////////////////////////////////////////////*
/* Problem Constants */
#define STATES_NO RCONST(64) /* CHANGE THIS ACCORDING TO YOUR PROBLEM */
