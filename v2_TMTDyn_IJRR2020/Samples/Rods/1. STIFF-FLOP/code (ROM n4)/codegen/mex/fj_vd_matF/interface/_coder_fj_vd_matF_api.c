...
static const mxArray *emlrt_marshallOut(const real_T u[576]);
  ...
  static const mxArray *emlrt_marshallOut(const real_T u[576])
{
  ...
  static const int32_T iv1[2] = { 24, 24 };
                    ...
                    *plhs[1])
{
  ...
  fj_vd_mat = (real_T (*)[576])mxMalloc(sizeof(real_T [576]));
