 ...
 *
 * Code generation for function '_coder_fj_vd_matF_api'
 *
 */
...
#include "_coder_fj_vd_matF_api.h"
...
static const mxArray *emlrt_marshallOut(const real_T u[324]);
  ...
  static const mxArray *emlrt_marshallOut(const real_T u[324])
{
  ...
  static const int32_T iv1[2] = { 18, 18 };
...
void fj_vd_matF_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray
                    *plhs[1])
{
  real_T (*fj_vd_mat)[324];
  real_T (*in1)[34];
  real_T (*in2)[36];
  real_T s;
  ...
  fj_vd_mat = (real_T (*)[324])mxMalloc(sizeof(real_T [324]));
  ...
  fj_vd_matF(*in1, *in2, s, *fj_vd_mat);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*fj_vd_mat);
}

/* End of code generation (_coder_fj_vd_matF_api.c) */
