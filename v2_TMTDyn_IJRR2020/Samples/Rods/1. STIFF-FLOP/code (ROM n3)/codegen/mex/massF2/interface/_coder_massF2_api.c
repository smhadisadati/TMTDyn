 ...
 * _coder_massF2_api.c
 *
 * Code generation for function '_coder_massF2_api'
 *
 */
...
static const mxArray *b_emlrt_marshallOut(const real_T u[108]);
  ...
  static const mxArray *b_emlrt_marshallOut(const real_T u[108])
{
  ...
  static const int32_T iv3[2] = { 6, 18 };
...
void massF2_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray *
                plhs[4])
{
  real_T (*out1)[36];
  real_T (*out2)[108];
  ...
  out2 = (real_T (*)[108])mxMalloc(sizeof(real_T [108]));
  out3 = (real_T (*)[108])mxMalloc(sizeof(real_T [108]));
  ...
  massF2(&st, *in1, *in2, s, *out1, *out2, *out3, *out4);
...
/* End of code generation (_coder_massF2_api.c) */
