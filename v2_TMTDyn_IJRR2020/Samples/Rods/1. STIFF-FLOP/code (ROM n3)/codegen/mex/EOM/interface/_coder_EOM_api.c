...
static void hb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, real_T ret[3975]);
...
static void n_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, real_T y[3975]);
...
static void fb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, real_T ret[3180])
{
  static const int32_T dims[2] = { 795, 4 };

  real_T (*r2)[3180];
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r2 = (real_T (*)[3180])emlrtMxGetData(src);
  memcpy(&ret[0], &(*r2)[0], 3180U * sizeof(real_T));
  emlrtDestroyArray(&src);
}
...
static void gb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, real_T ret[5565])
{
  static const int32_T dims[2] = { 795, 7 };

  real_T (*r3)[5565];
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r3 = (real_T (*)[5565])emlrtMxGetData(src);
  memcpy(&ret[0], &(*r3)[0], 5565U * sizeof(real_T));
  emlrtDestroyArray(&src);
}
...
static void hb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, real_T ret[3975])
{
  static const int32_T dims[2] = { 795, 5 };

  real_T (*r4)[3975];
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r4 = (real_T (*)[3975])emlrtMxGetData(src);
  memcpy(&ret[0], &(*r4)[0], 3975U * sizeof(real_T));
  emlrtDestroyArray(&src);
}
  ...
  emlrtMsgIdentifier *msgId, real_T ret[3])
{
  ...
  real_T (*r5)[3];
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r5 = (real_T (*)[3])emlrtMxGetData(src);
  ret[0] = (*r5)[0];
  ret[1] = (*r5)[1];
  ret[2] = (*r5)[2];
  emlrtDestroyArray(&src);
  ...
  emlrtMsgIdentifier *msgId, real_T ret[18])
{
  ...
  real_T (*r7)[18];
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r7 = (real_T (*)[18])emlrtMxGetData(src);
  memcpy(&ret[0], &(*r7)[0], 18U * sizeof(real_T));
  emlrtDestroyArray(&src);
}
  ...
  emlrtMsgIdentifier *msgId, real_T ret[2])
{
  ...
  real_T (*r8)[2];
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r8 = (real_T (*)[2])emlrtMxGetData(src);
  ret[0] = (*r8)[0];
  ret[1] = (*r8)[1];
  emlrtDestroyArray(&src);
}
  ...
  emlrtMsgIdentifier *msgId, real_T ret[19])
{
  ...
  real_T (*r9)[19];
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r9 = (real_T (*)[19])emlrtMxGetData(src);
  memcpy(&ret[0], &(*r9)[0], 19U * sizeof(real_T));
  emlrtDestroyArray(&src);
}
               ...
               const mxArray *plhs[1])
{
  ...
  dz_data = (real_T (*)[54])mxMalloc(sizeof(real_T [54]));
