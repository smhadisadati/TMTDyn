 ...
 *
 * _coder_sprdmpF19_api.c
 *
 * Code generation for function '_coder_sprdmpF19_api'
 *
 */
...
static const mxArray *d_emlrt_marshallOut(const real_T u[108]);
...
static const mxArray *emlrt_marshallOut(const real_T u[108]);
  ...
  static const mxArray *d_emlrt_marshallOut(const real_T u[108])
{
  ...
  static const int32_T iv7[2] = { 6, 18 };
  ...
  static const mxArray *emlrt_marshallOut(const real_T u[108])
{
  ...
  static const int32_T iv1[2] = { 18, 6 };
...
void sprdmpF19_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray
                   *plhs[8])
{
  real_T (*out1)[108];
  real_T (*out2)[6];
  ...
  out5 = (real_T (*)[3])mxMalloc(sizeof(real_T [3]));
  out6 = (real_T (*)[108])mxMalloc(sizeof(real_T [108]));
  out7 = (real_T (*)[108])mxMalloc(sizeof(real_T [108]));
  ...
  sprdmpF19(&st, *in1, *in2, s, *out1, *out2, *out3, *out4, *out5, *out6, *out7,
            &out8);
  ...
  if (nlhs > 7) {
    plhs[7] = e_emlrt_marshallOut(out8);
  }
}

/* End of code generation (_coder_sprdmpF19_api.c) */
