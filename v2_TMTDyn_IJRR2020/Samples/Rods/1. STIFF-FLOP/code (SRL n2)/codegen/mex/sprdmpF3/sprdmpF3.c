...
static emlrtRSInfo emlrtRSI = { 29,    /* lineNo */
  "sprdmpF3",                          /* fcnName */
  "/home/hadi/MEGAsync/Hadi/AutoTMTDyn/Code/AutoTMTDyn/Beta/v1.0/code/sprdmpF3.m"/* pathName */
};
...
void sprdmpF3(const emlrtStack *sp, const real_T in1[34], const real_T in2[12],
              real_T s, real_T out1[6], real_T *out2, real_T *out3, real_T *out4,
              real_T *out5, real_T out6[6], real_T out7[6], real_T *out8)
{
  int32_T i;
  static const int8_T iv0[6] = { 0, 0, 1, 0, 0, 0 };
  ...
  st.site = &d_emlrtRSI;
  b_st.site = &i_emlrtRSI;
  t9 = in1[33] * in1[33] * (t11 * t11);
  t11 = 1.0 / in1[4];
  st.site = &e_emlrtRSI;
  b_st.site = &i_emlrtRSI;
  st.site = &f_emlrtRSI;
  b_st.site = &i_emlrtRSI;
  t16 = t2 * (in1[2] * in1[2] - in1[3] * in1[3]) - t4 * t6 * (t9 - 1.0) * 6.0;
  *out2 = in1[1] * in2[2] * t2 * t11 * t16 * 3.1415926535897931;
  st.site = &g_emlrtRSI;
  b_st.site = &i_emlrtRSI;
  *out3 = -in1[7] * in2[8] * muDoubleScalarPower(muDoubleScalarAbs(in2[8]), in1
    [11] - 1.0);
  *out4 = -t4 * t6 * (t9 - 1.0) * 3.1415926535897931 * (((((in1[21] + in1[22]) +
    in1[23]) + in1[24]) + in1[25]) + in1[26]);
  *out5 = in2[2];
  out6[0] = 0.0;
  out6[1] = 0.0;
  out6[2] = -in1[1] * t2 * t11 * t16 * 3.1415926535897931;
  out6[3] = 0.0;
  out6[4] = 0.0;
  out6[5] = 0.0;
  st.site = &h_emlrtRSI;
  ...
  out7[0] = 0.0;
  out7[1] = 0.0;
  out7[2] = -in1[7] * muDoubleScalarPower(in2[8], in1[11] - 1.0);
  out7[3] = 0.0;
  out7[4] = 0.0;
  out7[5] = 0.0;
  *out8 = 1.0;
...
/* End of code generation (sprdmpF3.c) */
