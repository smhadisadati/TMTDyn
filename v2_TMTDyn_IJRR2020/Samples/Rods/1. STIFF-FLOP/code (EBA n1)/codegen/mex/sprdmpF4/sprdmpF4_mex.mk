...
MAKEFILE = sprdmpF4_mex.mk

include sprdmpF4_mex.mki


SRC_FILES =  \
	sprdmpF4_data.c \
	sprdmpF4_initialize.c \
	sprdmpF4_terminate.c \
	sprdmpF4.c \
	_coder_sprdmpF4_info.c \
	_coder_sprdmpF4_api.c \
	_coder_sprdmpF4_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF4_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF4"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF4/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF4/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF4/%.cu
	$(CC) $(CCFLAGS) "$<"
