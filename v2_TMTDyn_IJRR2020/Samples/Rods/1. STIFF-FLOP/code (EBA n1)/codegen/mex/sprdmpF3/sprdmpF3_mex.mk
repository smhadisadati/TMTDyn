...
MAKEFILE = sprdmpF3_mex.mk

include sprdmpF3_mex.mki


SRC_FILES =  \
	sprdmpF3_data.c \
	sprdmpF3_initialize.c \
	sprdmpF3_terminate.c \
	sprdmpF3.c \
	_coder_sprdmpF3_info.c \
	_coder_sprdmpF3_api.c \
	_coder_sprdmpF3_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF3_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF3"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF3/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF3/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF3/%.cu
	$(CC) $(CCFLAGS) "$<"
