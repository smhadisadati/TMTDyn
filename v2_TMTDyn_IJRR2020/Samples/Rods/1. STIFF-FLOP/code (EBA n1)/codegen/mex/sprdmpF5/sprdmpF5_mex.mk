...
MAKEFILE = sprdmpF5_mex.mk

include sprdmpF5_mex.mki


SRC_FILES =  \
	sprdmpF5_data.c \
	sprdmpF5_initialize.c \
	sprdmpF5_terminate.c \
	sprdmpF5.c \
	_coder_sprdmpF5_info.c \
	_coder_sprdmpF5_api.c \
	_coder_sprdmpF5_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = sprdmpF5_mex
...
SYS_INCLUDE += -I "/home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF5"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF5/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF5/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/hadi/Safe/MEGAsync/Hadi/TMTDyn/Code/TMTDyn/Beta/v1.0/Rods/1.\ STIFF-FLOP/code/codegen/mex/sprdmpF5/%.cu
	$(CC) $(CCFLAGS) "$<"
