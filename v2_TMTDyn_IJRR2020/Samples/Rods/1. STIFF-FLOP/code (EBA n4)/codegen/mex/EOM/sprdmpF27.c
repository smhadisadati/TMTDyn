...
static emlrtRSInfo rf_emlrtRSI = { 63, /* lineNo */
  "sprdmpF27",                         /* fcnName */
  "/home/hadi/MEGAsync/Hadi/AutoTMTDyn/Code/AutoTMTDyn/Beta/v1.0/code/sprdmpF27.m"/* pathName */
};

static emlrtRSInfo vf_emlrtRSI = { 93, /* lineNo */
  "sprdmpF27",                         /* fcnName */
  "/home/hadi/MEGAsync/Hadi/AutoTMTDyn/Code/AutoTMTDyn/Beta/v1.0/code/sprdmpF27.m"/* pathName */
};

static emlrtRSInfo wf_emlrtRSI = { 105,/* lineNo */
  "sprdmpF27",                         /* fcnName */
  "/home/hadi/MEGAsync/Hadi/AutoTMTDyn/Code/AutoTMTDyn/Beta/v1.0/code/sprdmpF27.m"/* pathName */
};

static emlrtRSInfo rg_emlrtRSI = { 310,/* lineNo */
  "sprdmpF27",                         /* fcnName */
  "/home/hadi/MEGAsync/Hadi/AutoTMTDyn/Code/AutoTMTDyn/Beta/v1.0/code/sprdmpF27.m"/* pathName */
};

static emlrtRSInfo sg_emlrtRSI = { 311,/* lineNo */
  "sprdmpF27",                         /* fcnName */
  "/home/hadi/MEGAsync/Hadi/AutoTMTDyn/Code/AutoTMTDyn/Beta/v1.0/code/sprdmpF27.m"/* pathName */
};

static emlrtRSInfo ug_emlrtRSI = { 314,/* lineNo */
  "sprdmpF27",                         /* fcnName */
  "/home/hadi/MEGAsync/Hadi/AutoTMTDyn/Code/AutoTMTDyn/Beta/v1.0/code/sprdmpF27.m"/* pathName */
};
               ...
               real_T out1[144], real_T out2[6], real_T out3[6], real_T out4[6])
{
  ...
  out1[54] = t52_tmp * -2.0 - t50_tmp;
  out1[55] = t9 - in2[10] * in2[11] * 2.0;
  out1[56] = t161;
  out1[57] = t156;
  out1[58] = t160;
  out1[59] = ((((t29 + t31) - t73_tmp) - t72_tmp) - t74_tmp) - t32_tmp;
  out1[60] = t162;
  out1[61] = -t9 + t53_tmp;
  out1[62] = (-t10 - t11) + 1.0;
  memset(&out1[63], 0, 18U * sizeof(real_T));
  out1[81] = (t41 * -2.0 + t184) - t20;
  out1[82] = (-t35 + t25) - t17;
  out1[83] = t188;
  out1[84] = 0.0;
  out1[85] = 0.0;
  ...
  out1[105] = (t35 + t212) - t17;
  out1[106] = (t41 * -2.0 + t211) - t248;
  out1[107] = (-t49 + t213) - t19;
  out1[108] = 0.0;
  out1[109] = 0.0;
  out1[110] = 0.0;
  out1[111] = in2[11] * -2.0 + t216;
  out1[112] = t215;
  out1[113] = t219;
  memset(&out1[114], 0, 15U * sizeof(real_T));
  out1[129] = (in2[16] * -2.0 + t65) - t26_tmp;
  out1[130] = (t49 + t237) - t19;
  t5 = t3 * t12 * 2.0;
  out1[131] = (t41 * -2.0 + t235) - t5;
  out1[132] = 0.0;
  out1[133] = 0.0;
  out1[134] = 0.0;
  out1[135] = t2;
  out1[136] = in2[9] * -2.0 + t242;
  out1[137] = t4;
  out1[138] = 0.0;
  out1[139] = 0.0;
  out1[140] = 0.0;
  ...
  out2[5] = t211 * t86 * 3.1415926535897931 * (((in2[10] * t36 * 2.0 - in2[9] *
    t42 * 2.0) - in2[11] * t89 * 2.0) + t6 * t43 * 2.0) * -0.66666666666666663;
  t235 = in1[5] * t98 * t117;
  t242 = in1[5] * t99 * t117;
  t5 = in1[5] * t100 * t117;
