...
static real_T (*c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *in2,
  const char_T *identifier))[236];
static real_T (*d_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId))[236];
...
static real_T (*emlrt_marshallIn(const emlrtStack *sp, const mxArray *in1, const
  char_T *identifier))[6];
static const mxArray *emlrt_marshallOut(const real_T u[96]);
static real_T f_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId);
static real_T (*g_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId))[6];
static real_T (*h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId))[236];
  ...
  static const mxArray *emlrt_marshallOut(const real_T u[96])
{
  ...
  static const int32_T iv1[2] = { 16, 6 };
...
{
  real_T (*ret)[236];
  static const int32_T dims[2] = { 1, 236 };

  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  ret = (real_T (*)[236])emlrtMxGetData(src);
  emlrtDestroyArray(&src);
  return ret;
}
                ...
                plhs[1])
{
  ...
  r_jtip = (real_T (*)[96])mxMalloc(sizeof(real_T [96]));
